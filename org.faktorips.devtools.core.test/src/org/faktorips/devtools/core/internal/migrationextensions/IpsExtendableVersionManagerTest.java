...
public class IpsExtendableVersionManagerTest extends AbstractIpsPluginTest {
    ...
    public void testIsCurrentVersionCompatibleWith() throws Exception {
        ...
        // assertFalse(ipsExtendableVersionManager.isCurrentVersionCompatibleWith(currentVersion +
        // "zzz"));
    }
    ...
    //
    // Map<Version, IIpsProjectMigrationOperationFactory> registeredMigrations = new
    // HashMap<Version, IIpsProjectMigrationOperationFactory>();
    ...
    // @Override
    // public AbstractIpsProjectMigrationOperation createIpsProjectMigrationOpertation(IIpsProject
    // ipsProject,
    // String featureId) {
