...
public class TestCaseTypeTest extends AbstractIpsPluginTest {
    ...
    public void testDependsOn() throws Exception {
        ...
        assertTrue(dependsOnList.contains(IpsObjectDependency.createReferenceDependency(type.getQualifiedNameType(), pcType1.getQualifiedNameType())));
        ...
        assertTrue(dependsOnList.contains(IpsObjectDependency.createReferenceDependency(type.getQualifiedNameType(), pcType1.getQualifiedNameType())));
        assertTrue(dependsOnList.contains(IpsObjectDependency.createReferenceDependency(type.getQualifiedNameType(), pcType2.getQualifiedNameType())));
        ...
        assertTrue(dependsOnList.contains(IpsObjectDependency.createReferenceDependency(type.getQualifiedNameType(), pcType1.getQualifiedNameType())));
        assertTrue(dependsOnList.contains(IpsObjectDependency.createReferenceDependency(type.getQualifiedNameType(), pcType2.getQualifiedNameType())));
        assertTrue(dependsOnList.contains(IpsObjectDependency.createReferenceDependency(type.getQualifiedNameType(), pcType3.getQualifiedNameType())));
    }
