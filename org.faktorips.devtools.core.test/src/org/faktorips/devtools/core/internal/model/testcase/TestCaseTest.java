...
public class TestCaseTest extends AbstractIpsPluginTest {
    ...
    public void testDependsOn() throws Exception {
        ...
        assertTrue(dependsOnList.contains(IpsObjectDependency.createInstanceOfDependency(testCase.getQualifiedNameType(), testCaseType.getQualifiedNameType())));
        ...
        assertTrue(dependsOnList.contains(IpsObjectDependency.createReferenceDependency(testCase.getQualifiedNameType(), prodCmpt1.getQualifiedNameType())));
        ...
        assertTrue(dependsOnList.contains(IpsObjectDependency.createReferenceDependency(testCase.getQualifiedNameType(), prodCmpt1.getQualifiedNameType())));
        assertTrue(dependsOnList.contains(IpsObjectDependency.createReferenceDependency(testCase.getQualifiedNameType(), prodCmpt2.getQualifiedNameType())));
    }
