...
public abstract class AttributeCollector<T extends IModelTypeAttribute, D extends AbstractAttributeDescriptor<T>>
extends ModelPartCollector<T, D> {
    ...
    static class IpsAttributeProcessor<D extends AbstractAttributeDescriptor<? extends IModelTypeAttribute>> extends
    ...
    static class IpsAttributeSetterProcessor<D extends AbstractAttributeDescriptor<? extends IModelTypeAttribute>>
            extends AnnotationProcessor<IpsAttributeSetter, D> {
