...
class SimpleGetterMethodCollector<E extends IModelElement, P extends Annotation, C extends Annotation> extends
    ...
    @Override
    public LinkedHashMap<String, E> createParts(IModelElement parentModel) {
