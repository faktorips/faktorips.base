...
/**
 * Helper class that represents an model type that was generated by Faktor-IPS ans has all meta data
 * in annotations. The meta data for one model type is split in interface and implementation and may
 * have additional classes like generations for product component. This class could be used to read
