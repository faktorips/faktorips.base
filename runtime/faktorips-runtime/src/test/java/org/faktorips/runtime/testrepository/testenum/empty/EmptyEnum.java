package org.faktorips.runtime.testrepository.testenum.empty;
...
@IpsEnumType(name = "empty.EmptyEnum", attributeNames = { "id", "name" })
@IpsExtensibleEnum(enumContentName = "empty.EmptyEnum")
public final class EmptyEnum implements Serializable, Comparable<EmptyEnum>, IToXmlSupport {
     ...
     */
    @IpsGenerated
    protected EmptyEnum(int index, String idString, String nameString, IRuntimeRepository productRepository) {
        this.index = index;
        id = idString;
        name = nameString;
     ...
     */
    @IpsGenerated
    public EmptyEnum(int index, String id, String name) {
        this.index = index;
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof EmptyEnum) {
            return getId().equals(((EmptyEnum)obj).getId());
        }
        return false;
    }
        ...
        if (productRepository != null) {
            ...
            if (runtimeRepositoryLookup == null) {
                throw new IllegalStateException(
                        "For serialization of EmptyEnum instances you need to set an IRuntimeRepositoryLookup in your runtime repository.");
            }
    ...
    private static class SerializationProxy implements Serializable {
        ...
        private Object readResolve() {
            return runtimeRepositoryLookup.getRuntimeRepository().getEnumValue(EmptyEnum.class, id);
        }
    }
}
