...
@IpsEnumType(name = "produkt.ExtensibleEnum", attributeNames = { "id", "name" })
@IpsExtensibleEnum(enumContentName = "produkt.ExtensibleEnum")
public final class ExtensibleEnum implements Serializable, Comparable<ExtensibleEnum>, IToXmlSupport {
     ...
     */
    @IpsGenerated
    protected ExtensibleEnum(int index, String idString, String nameString, IRuntimeRepository productRepository) {
        this.index = index;
        id = idString;
        name = nameString;
     ...
     */
    @IpsGenerated
    public ExtensibleEnum(int index, String id, String name) {
        this.index = index;
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ExtensibleEnum) {
            return getId().equals(((ExtensibleEnum)obj).getId());
        }
        return false;
    }
    ...
    @Override
    @IpsGenerated
    public int compareTo(ExtensibleEnum o) {
        ...
        if (productRepository != null) {
            ...
            if (runtimeRepositoryLookup == null) {
                throw new IllegalStateException(
                        "For serialization of ExtensibleEnum instances you need to set an IRuntimeRepositoryLookup in your runtime repository.");
            }
    ...
    private static class SerializationProxy implements Serializable {
        ...
        private Object readResolve() {
            return runtimeRepositoryLookup.getRuntimeRepository().getEnumValue(ExtensibleEnum.class, id);
        }
    }
}
