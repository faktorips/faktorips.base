...
@IpsTableStructure(name = "tables.TestTable", type = TableStructureKind.SINGLE_CONTENT, columns = { "company",
        "Gender", "rate" })
public class TestSingleContentTable extends Table<TestTableRow> {
     ...
     * @generated
     */
    public TestSingleContentTable(String qName) {
        super(qName);
        rows = new ArrayList<>();
        init();
    }
     ...
     * @generated
     */
    public TestSingleContentTable(List<TestTableRow> content) {
        super();
     ...
     * @generated
     */
    public static final TestSingleContentTable getInstance(IRuntimeRepository repository, String qualifiedTableName) {
        return (TestSingleContentTable)repository.getTable(qualifiedTableName);
    }
}
