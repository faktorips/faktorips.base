...
public class Decimal extends Number implements Comparable<Decimal>, NullObjectSupport, Serializable {
    ...
    /**
     * Returns the sum of the values. If either the values array or one of the values is <code>null</code>
     * the method returns <code>Decimal.NULL</code>.
     */
    ...
    /**
     * Returns a Decimal whose value is <code>(this + d)</code>, and whose
     * scale is <code>max(this.scale(), d.scale())</code>.
     * 
    ...
    /**
     * Returns a Decimal whose value is <code>(this + i)</code>, and whose
    ...
    /**
     * Returns a Decimal whose value is <code>(this * d)</code>, and whose
     * scale is <code>(this.scale() + d.scale())</code>.
     * <p>
     * Returns <code>Decimal.NULL</code> if either this is <code>Decimal.NULL</code> or
     * d is <code>null</code> or d is <code>Decimal.NULL</code>.
     * 
    ...
    /**
     * Returns a Money whose value is <code>(this * m.getAmount())</code> and that has
     * the same currency as the given currency.
     * <p>
     * Returns <code>Money.NULL</code> if either this is <code>Decimal.NULL</code> or
     * m is <code>null</code> or m is <code>Money.NULL</code>.
     * 
    ...
    /**
     * Returns a Decimal whose value is <code>(this * l)</code>, and whose
     * scale is <code>this.scale()</code>.
     *
     ...
     * the division.
     * <p>
     * Note that since Decimal objects are immutable, calls of this
    ...
    /**
     * Returns a decimal that is rounded with the given rounding mode and precision and has
     * (in contrast to the <code>setScale(int, int)</code> method) the same scale as this decimal.
     * 
    ...
    /**
     * Returns true if the indicated Decimal is greater than this one.
     * Two Decimals that are equal in value but have a different scale (like
     * 2.0 and 2.00) are considered equal by this method.
     * If d is <code>null</code> or <code>Decimal.NULL</code> the method returns
     * false.
     */
    ...
    /**
     * Returns true if the indicated Decimal is greater or equal than this one.
     * Two Decimals that are equal in value but have a different scale (like
     * 2.0 and 2.00) are considered equal by this method.
     * If d is <code>null</code> or <code>Decimal.NULL</code> the method returns
     * false.
    ...
    /**
     * Returns true if the indicated Decimal is smaller than this one.
     * Two Decimals that are equal in value but have a different scale (like
     * 2.0 and 2.00) are considered equal by this method.
     * If d is <code>null</code> or <code>Decimal.NULL</code> the method returns
     * false.
    ...
    /**
     * Returns true if the indicated Decimal is smaller than or equal to this one.
     * Two Decimals that are equal in value but have a different scale (like
     * 2.0 and 2.00) are considered equal by this method.
     * If d is <code>null</code> or <code>Decimal.NULL</code> the method returns
     * false.
    ...
    /**
     * Returns true if the indicated Decimal is equal to this one.
     * Two Decimals that are equal in value but have a different scale (like
     * 2.0 and 2.00) are considered equal by this method in contrast to the
     * <code>equals(Object o)</code> method.
     * <p>
     * If d is <code>null</code> or <code>Decimal.NULL</code> the method returns
     * false.
     * 
    ...
    /**
     * Returns true if the indicated Decimal is not equal to this one.
     * Two Decimals that are equal in value but have a different scale (like
     * 2.0 and 2.00) are considered equal by this method in contrast to the
     * <code>equals(Object o)</code> method.
     * <p>
    ...
    /**
     * Compares this Decimal with the specified Object for
     * equality.
     * <strong>
     * Note that unlike the BigDecimal class this method ignores the value's
     * scale. This decision was made as most people consider 1.0 and 1.00 as equal.
     * </strong>
     */
    @Override
    ...
    /**
     * Returns the hash code for the decimal value.
     * <strong>
     * Note that unlike the BigDecimal class this class ignores the value's
     * scale when comparing for equality. Thus this method returns the same
     * hash code for 1.0 and 1.00 for example.
     * </strong>
     */
    @Override
    public int hashCode() {
