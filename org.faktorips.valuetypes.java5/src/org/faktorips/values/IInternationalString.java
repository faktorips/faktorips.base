...
/**
 * An {@link IInternationalString} could be used for string properties that could be translated in
 * different languages.
 */
public interface IInternationalString extends Serializable {
