 ...
 * <code>java.lang.Float</code> because of the loss of precision. If you wan't
...
public class Money implements Comparable<Money>, NullObjectSupport, Serializable {
	...
	/**
	 * Returns a money object with the currency euro and an amount defined by the given euros and cents.
	 */
    ...
    /**
     * Returns a money object with the currency euro and an amount defined by the given euros and 0 cents.
     */
    ...
    /**
	 * Returns a money object with the currency us dollar and an amount defined by the given usdollars and cents.
	 */
    ...
    /**
     * Returns a money object with the currency us dollar and an amount defined by the given usdollars and 0 cents.
     */
        ...
        try {
            ...
            if (dotPos > 0) {
                majorUnits = Long.valueOf(value.substring(0, dotPos).trim())
                        .longValue();
                minorUnits = Integer.valueOf(value.substring(dotPos + 1).trim())
                        .intValue();
            ...
            throw (IllegalArgumentException) new IllegalArgumentException("Can't parse " + value).initCause(e);
        }
	}

	/**
	 * Returns a money value in the indicated currency and with the indicated
	 * number of major units (e.g. Euro or US Dollar) and minor units (e.g.
	 * Cents).
	 */
	public final static Money valueOf(long majorUnits, int minorUnits,
			Currency currency) {
		...
		long intAmount = majorUnits
				* power10[currency.getDefaultFractionDigits()] + minorUnits;
     ...
     * @throws IllegalArgumentException if the value's scale is greater than the currency's
     * default fraction digits, e.g. value is 10.324 (scale 3) and currency is Euro with 2 digits.
     */
    ...
    /**
     * Returns a money value with the indicated value and currency. If the value's scale
	...
	/**
	 * Returns the money value's currency. For the special case MoneyNull the
	 * method returns null.
	 */
	...
	/**
	 * Returns true if this instance represents the special case null, otherwise
	 * false.
	 */
	 ...
	 *
	 * @return A money value with the same currency this value object has and an
	 *         amount that is the sum of this value's amount and the passed
	 *         value's amount. Returns Money.NULL if either this object is the
	...
	public Money add(Money value) {
		...
		if (!currency.equals(value.currency)) {
			throw new IllegalArgumentException("Can't add " + this + " and "
					+ value + " because they have different currencies.");
		}
	 ...
	 *
	 * @return A money value with the same currency this money object has and an
	 *         amount that is this value's amount minus the passed value's amount.
	 *         Returns Money.NULL if either this object is the Money.NULL
	...
	/**
	 * Multiplies this money amount with the given decimal value. If rounding is
	 * required to set the scale to the currencie's number of fractional digits
	 * the given rounding mode is used.
	 *
	...
	/**
	 * Divides this money amount by the given divisor. If rounding is
	 * required to set the scale to the currencie's number of fractional digits
	 * the given rounding mode is used.
	 *
	 * @param d The divisor.
	...
	public Money divide(int d, int roundingMode) {
		long newAmount = getAmount().divide(d,
				currency.getDefaultFractionDigits(), roundingMode).multiply(
	 ...
	 *
	 * @throws IllegalArgumentException if this money and the other money object have different currencies.
	 * @throws IllegalArgumentException if this either this money or the other money object are <code>Money.Null</code>
	...
	/**
	 * Returns true if this Money is greater than the other money object.
     * If either this money object or other is <code>Money.NULL</code> the method returns false.
     *
     * @throws NullPointerException if other is <code>null</code>.
     * @throws IllegalArgumentException if this money object and the other money object have different currencies.
	 */
	...
	/**
	 * Returns true if this Money is greater than or equal to the other money object.
     * If either this money object or other is <code>Money.NULL</code> the method returns
	 * false.
	 *
     * @throws NullPointerException if other is <code>null</code>.
     * @throws IllegalArgumentException if this money object and the other money object have different currencies.
	...
	/**
	 * Returns true if this Money is less than the other money object.
     * If either this money object or other is <code>Money.NULL</code> the method returns
	 * false.
	 *
     * @throws NullPointerException if other is <code>null</code>.
	...
	/**
	 * Returns true if the this Money is less than or equal to the other money object.
	 * Two Moneys that are equal in value but have a different scale (like
    ...
    /**
     * Returns the maximum of the two values. If the two values are equals <code>this</code>
     * will be returned.  
     */
    ...
    /**
     * Returns the minimum of the two values. If the two values are equals <code>this</code>
     * will be returned.  
     */
	...
	public boolean equals(Object o) {
		...
		Money other = (Money) o;
		return internalAmount == other.internalAmount
