...
public abstract class AbstractFipsDocTest extends AbstractIpsPluginTest {
	...
	protected void createMassivProjekt() {
		try {
			...
			IProductCmptType krankenBVBArt = (ProductCmptType) ipsProject.findIpsObject(
					IpsObjectType.PRODUCT_CMPT_TYPE, krankenBVB.getProductCmptType());
			...
			IProductCmptGeneration krankenBvbBeitragXyzGeneration = (IProductCmptGeneration) krankenBvbBeitragXyz.newGeneration(cal);
			...
			IProductCmptGeneration krankenBvbBeitragZyxGeneration = (IProductCmptGeneration) krankenBvbBeitragZyx.newGeneration(cal);
			krankenBvbBeitragXyzGeneration.setDescription("Ich bin ne Generation der BVB für den Beitrag!");
