...
public abstract class GenericValueDatatype implements ValueDatatype {
    ...
    public MessageList checkReadyToUse() {
        ...
        if (getAdaptedClass() == null) {
            String text = "The Java class represented by the datatype can't be found. (Classname: "
                    + getAdaptedClassName()
                    + "). "
    ...
    protected Method getIsParsableMethod() {
        if (isParsableMethod == null && isParsableMethodName != null) {
            try {
                ...
                throw new RuntimeException("Can't get the method isParsable(String), Class: " + getAdaptedClassName()
                        + ", Methodname: " + isParsableMethodName, e);
            }
        }
    ...
    protected Method getValueOfMethod() {
        if (valueOfMethodName != null && valueOfMethod == null) {
            try {
                ...
                throw new RuntimeException("Can't get valueOfMethod(String), Class: " + getAdaptedClass()
                        + ", Methodname: " + valueOfMethodName);
            }
        }
    ...
    protected Method getToStringMethod() {
        if (toStringMethod == null && toStringMethodName != null) {
            try {
                ...
                throw new RuntimeException("Can't get method toString(String), Class: " + getAdaptedClass()
                        + ", Methodname: " + toStringMethodName);
            }
        }
    ...
    public int compare(String valueA, String valueB) throws UnsupportedOperationException {
        if (!supportsCompare()) {
            throw new UnsupportedOperationException("The class " + getAdaptedClassName() + " does not implement "
