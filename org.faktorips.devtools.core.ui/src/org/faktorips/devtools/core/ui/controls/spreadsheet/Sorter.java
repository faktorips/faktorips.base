...
/**
 * The table sorter is the default sorter of the table control.
 * It triggers a resort the the given column depending on the
 * comparator suitable for the type of the column.
 *  
 * @author Jacobi
 */
public class Sorter extends ViewerSorter
{
	 ...
	 * @return int, either <code>ASCENDING</code>, <code>DESCENDING</code>,
	 *         <code>NATURAL</code>.
	 */
	int getOrder()
	{
