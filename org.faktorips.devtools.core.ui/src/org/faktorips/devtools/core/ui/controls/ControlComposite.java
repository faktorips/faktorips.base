...
/**
 * A composite that is used to build complex controls. >p> Provides the
 * <code>listenToControl()</code> method that complex controls use to register their primitive
 * controls. This allows events triggered by the primitive controls to be broadcasted to listeners
