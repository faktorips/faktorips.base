...
/**
 * The table cell editControl is a wrapper class that manages the editing
 * of table cells. It allocates a type-safe field editControl instance for the 
 * column it edits and handles activation and deactivation.
 * 
...
class TableCellEditor
{
	...
	/**
	 * Activate the editControl. The editControl instance is the sizing parent of the
	 * editControl control.
	 * 
	...
	/**
	 * Processes a key event of the edit control. This implements 
	...
	/**
	 * Commit the changes and deactivate the editControl.
	 * This will automatically refresh the current line of 
	 * the table viewer.
	 */
	 ...
	 * 
	 * @param traversal, the <code>SWT.TRAVERSE_</code> value of the 
	 *        traversal event to trigger. 
	 */
	 ...
	 * 
	 * This works currently only for text controls. Other controls
	...
	/**
	 * Calculate the control height for the edit control.
	 * This method is used by the table control to calculate the required
	 * row height.
	 *  
