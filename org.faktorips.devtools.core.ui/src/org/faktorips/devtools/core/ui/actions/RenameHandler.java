    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (selection instanceof IStructuredSelection) {
            ...
            if (selected instanceof IIpsElement) {
                ...
                Refactoring refactoring = selectedElement.getRenameRefactoring();
                if (refactoring != null) {
                    ...
                    RefactoringWizard renameWizard = new RenameRefactoringWizard(refactoring, selectedElement);
                    openWizard(shell, renameWizard);

                    return null;
                }

                if (selected instanceof IIpsElement) {
                    MoveWizard move = new MoveWizard(structuredSelection, MoveWizard.OPERATION_RENAME);
