 ...
 */
public interface IDescriptionWorkbenchAdapter {

    /**
     * Returns the description for the given IPS element.
     * 
     * @param ipsElement The IPS element to retrieve the description for.
     */
