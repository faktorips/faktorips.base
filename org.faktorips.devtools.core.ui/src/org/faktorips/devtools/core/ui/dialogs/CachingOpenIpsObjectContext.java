...
public abstract class CachingOpenIpsObjectContext implements ISelectIpsObjectContext {
    ...
    @Override
    public final List<IIpsSrcFile> getIpsSrcFiles(IProgressMonitor progressMonitor) throws CoreRuntimeException {
     ...
     */
    public abstract List<IIpsSrcFile> loadIpsSrcFiles(IProgressMonitor progressMonitor) throws CoreRuntimeException;
