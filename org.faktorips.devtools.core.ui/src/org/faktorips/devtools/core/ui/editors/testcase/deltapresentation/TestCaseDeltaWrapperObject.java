...
public class TestCaseDeltaWrapperObject {
    ...
    /**
     * Returns the text of the base object. The given label provider is used to delegate the getText method.
     */
    ...
    /**
     * Returns the image of the base object. The given label provider is used to delegate the getImage method.
     */
    public Image getImage(TestCaseLabelProvider labelProvider){
        if (isWillBeDeleted()){
            return getDeletedImage(labelProvider.getImage(baseObject));
        }else 
            return labelProvider.getImage(baseObject);
    }
    ...
    /** 
     * Returns <code>true</code> if the base object (test case model object) of this wrapper object will be
     * deleted or a parent of the base will be deleted. Because if a object will be deleted all the childs
     * will be deleted too.
     */
    ...
    /**
     * Returns if the base object has test attributes which will be deleted if the delta will be accepted.
     */
    ...
    /**
     * Sets if the base object has test attributes which will be deleted if the delta will be accepted.
     */
