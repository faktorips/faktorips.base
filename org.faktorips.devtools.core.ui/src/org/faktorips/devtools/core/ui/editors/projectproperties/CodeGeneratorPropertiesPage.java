...
public class CodeGeneratorPropertiesPage extends ProjectPropertyPage {
    final static String PAGEID = "Description";

    public CodeGeneratorPropertiesPage(FormEditor editor, String id, String title) {
        super(editor, id, title);
        // TODO Auto-generated constructor stub
    }

    public CodeGeneratorPropertiesPage(ProjectPropertyEditor projectPropertyEditor) {
