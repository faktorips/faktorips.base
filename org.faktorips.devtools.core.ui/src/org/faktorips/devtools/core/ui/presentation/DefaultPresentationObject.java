 ...
 */
@Deprecated
public class DefaultPresentationObject implements IPresentationObject {

    public Image getImage(IIpsElement element) throws CoreException {
        if (element instanceof IIpsSrcFile) {
            IIpsSrcFile ipsSrcFile = (IIpsSrcFile)element;
            return getEnclosingImage(ipsSrcFile);
    ...
    public Image getEnclosingImage(IIpsSrcFile ipsSrcFile) {
