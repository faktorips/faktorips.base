...
//            boolean filter = IpsObjectType.TEST_CASE.equals(getCorrespondingIpsSrcFile(match.getElement()).getIpsObjectType());
//            return filter;
//        }
//
//        /**
...
//         */
//        public boolean filters(Match match) {
//            boolean filter = IpsObjectType.PRODUCT_CMPT.equals(getCorrespondingIpsSrcFile(match.getElement()).getIpsObjectType());
//            return filter;
//        }
//        
//        /**
...
//        }
//        setActiveMatchFilters((MatchFilter[]) matchedFilterList.toArray(new MatchFilter[matchedFilterList.size()]));        
    }    
}
