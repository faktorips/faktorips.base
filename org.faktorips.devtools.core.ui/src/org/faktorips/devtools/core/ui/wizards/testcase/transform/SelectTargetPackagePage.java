...
/**
 * Wizard page to select the target ips package fragment where the new created test cases will
 * be stored.
 * 
...
public class SelectTargetPackagePage extends WizardPage {
	...
	/**
	 * Label provider wich shows the project, the package fragment root name and the package fragment.
	 */
