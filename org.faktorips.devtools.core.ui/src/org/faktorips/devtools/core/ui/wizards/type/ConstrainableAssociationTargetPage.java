...
public class ConstrainableAssociationTargetPage extends WizardPage {
    ...
    public void setSelection(ISelection selection) {
        if (selection != null) {
            association = (IAssociation)selection;
        }
    }
    ...
    protected static class CandidatesContentProvider extends SupertypeHierarchyPartsContentProvider {
        ...
        public CandidatesContentProvider(IType cmptType, ConstrainableAssociationTargetPage targetPage) {
            super(cmptType);
        ...
        public List<? extends IIpsObjectPart> getAvailableParts(IIpsObject ipsObject) {
            ...
            try {
                IType findTarget = targetPage.association.findTarget(cmptType.getIpsProject());

                return (List<? extends IIpsObjectPart>)findTarget.findSubtypes(true, true, cmptType.getIpsProject());
