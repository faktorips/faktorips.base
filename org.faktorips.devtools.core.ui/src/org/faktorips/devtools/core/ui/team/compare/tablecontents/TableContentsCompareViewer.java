...
public class TableContentsCompareViewer extends TextMergeViewer {
    ...
    /**
     * Creates a <code>TableContentsCompareViewer</code> using a <code>CompareViewerCompareContentProvider</code> as a 
     * content provider.
     * @param parent
     * @param cc
     */
    public TableContentsCompareViewer(Composite parent, CompareConfiguration configuration) {
        ...
        /* Configure the textcompare-engine in TextMergeViewer to ignore whitespace
         * for TableContents. This is necessary since rows may contain additional 
         * whitespace characters due to differing column widths. The text compare
         * must ignore those characters to be able to recognize rows of equal content.
         */
         ...
         * Cannot be set in configureTextViewer() as the TextMergeViewer sets the font in its 
    ...
    /**
     * Returns this TableContentsCompareViewer's title.
     * {@inheritDoc}
     */
