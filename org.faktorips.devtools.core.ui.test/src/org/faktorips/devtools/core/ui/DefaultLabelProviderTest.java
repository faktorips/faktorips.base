...
public class DefaultLabelProviderTest extends AbstractIpsPluginTest {
    ...
    // TODO these tests are disabled until the default label provider provides the images and labels
    // again
    ...
    public void testGetTextForIpsSourceFiles() throws CoreException {
        ...
        //        
        // IIpsSrcFile file = packageFragment.createIpsFile(IpsObjectType.TEST_CASE, ipsObjectName,
        // true, null);
    ...
    public void testGetImageForIpsSourceFiles() throws CoreException {
        // IIpsSrcFile file = packageFragment.createIpsFile(IpsObjectType.TEST_CASE,
        // "testCaseImageTest", true, null);
        // assertEquals(IpsObjectType.IPS_SOURCE_FILE.getImage(true), provider.getImage(file));
        // assertEquals(IpsObjectType.TEST_CASE.getImage(true),
        // providerWithIpsSourceFileMapping.getImage(file));
    }
}
