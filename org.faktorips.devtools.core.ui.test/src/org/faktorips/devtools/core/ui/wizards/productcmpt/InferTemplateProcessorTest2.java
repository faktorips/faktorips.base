...
public class InferTemplateProcessorTest2 extends AbstractIpsPluginTest {
    ...
    public void testRun_NullValueIsSetInTemplateTableContentUsage() throws CoreException {
        ...
        ArrayList<IProductCmpt> products = Lists.newArrayList(product);
        PropertyValueHistograms histograms = PropertyValueHistograms.createFor(products);

        InferTemplateProcessor processor = new InferTemplateProcessor(templateGeneration, products, histograms);
    ...
    public void testRun_ValidationRuleConfigsAreSetInTemplate() throws CoreException {
        ...
        ArrayList<IProductCmpt> products = Lists.newArrayList(product1, product2, product3);
        PropertyValueHistograms histograms = PropertyValueHistograms.createFor(products);
