...
/**
   ...
   protected static String LexicalError(boolean EOFSeen, int lexState, int errorLine, int errorColumn, String errorAfter, char curChar) {
      return(Messages.INSTANCE.getString("TokenMgrError.msgErrorAtLine") + //$NON-NLS-1$
           errorLine + Messages.INSTANCE.getString("TokenMgrError.msgColumn") + //$NON-NLS-1$
           errorColumn + Messages.INSTANCE.getString("TokenMgrError.msgEncountered") + //$NON-NLS-1$
           (EOFSeen ? "<EOF> " : ("\"" + addEscapes(String.valueOf(curChar)) + "\"") + " (" + (int)curChar + "), ") + //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
           Messages.INSTANCE.getString("TokenMgrError.msgAfter") + addEscapes(errorAfter) + "\""); //$NON-NLS-1$ //$NON-NLS-2$
   }
