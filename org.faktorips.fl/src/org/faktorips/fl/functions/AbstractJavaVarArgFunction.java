...
/**
 * {@link AbstractVarArgFunction} for {@link JavaCodeFragment Java code} generating functions.
 */
public abstract class AbstractJavaVarArgFunction extends AbstractVarArgFunction<JavaCodeFragment> {
     ...
     */
    public AbstractJavaVarArgFunction(String name, String description, Datatype type, Datatype argType) {
