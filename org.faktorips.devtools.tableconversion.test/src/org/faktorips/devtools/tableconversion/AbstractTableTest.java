...
public abstract class AbstractTableTest extends AbstractIpsPluginTest {
     ...
     */
    protected ITableContents createValidTableContents(IIpsProject ipsProject) throws CoreRuntimeException {
     ...
     */
    protected ITableContents createInvalidTableContents(IIpsProject ipsProject) throws CoreRuntimeException {
        ITableContents contents = (ITableContents)newIpsObject(ipsProject, IpsObjectType.TABLE_CONTENTS,
                "ExportSource");
        ITableRows exportSource = createExportSource(ipsProject, contents);
     ...
     * @throws CoreRuntimeException If the ipsProject is invalid or if this method is called more than once
     *             per test fixture.
     */
    public ITableStructure createTableStructure(IIpsProject ipsProject) throws CoreRuntimeException {
    ...
    private ITableRows createExportSource(IIpsProject ipsProject, ITableContents contents) throws CoreRuntimeException {
     ...
     * Creates valid table contents.
     */
    protected IEnumType createValidEnumTypeWithValues(IIpsProject ipsProject) throws CoreRuntimeException {
     ...
     */
    protected IEnumType createInvalidEnumTypeWithValues(IIpsProject ipsProject) throws CoreRuntimeException {
        IEnumType enumType = (IEnumType)newIpsObject(ipsProject, IpsObjectType.ENUM_TYPE, "EnumExportSource");
        enumType.setAbstract(false);
        enumType.setExtensible(false);
        enumType.newEnumLiteralNameAttribute();
