...
public interface IIpsObjectGeneration extends IIpsObjectPart {
     ...
     */
    public static final String TAG_NAME = "Generation"; //$NON-NLS-1$

    /**
     * Prefix for all message codes of this class.
     */
    public static final String MSGCODE_PREFIX = "IPSOBJECTGEN-"; //$NON-NLS-1$

    /**
     * Validation message code to indicate that the valid-from date of this generation is invalid.
     */
    public static final String MSGCODE_INVALID_VALID_FROM = MSGCODE_PREFIX + "InvalidValidFromDate"; //$NON-NLS-1$

    /**
     * Validation message code to indicate that the valid-from date of this generation is invalid.
     */
    public static final String MSGCODE_INVALID_VALID_FROM_DUPLICATE_GENERATION = MSGCODE_PREFIX
     ...
     * format.
     */
    public static final String MSGCODE_INVALID_FORMAT_VALID_FROM = MSGCODE_PREFIX + "InvalidValidFormatFromDate"; //$NON-NLS-1$
