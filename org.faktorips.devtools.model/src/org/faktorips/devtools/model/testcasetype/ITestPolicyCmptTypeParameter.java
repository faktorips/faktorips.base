...
public interface ITestPolicyCmptTypeParameter extends ITestParameter {
    ...
    String PROPERTY_REQUIRES_PRODUCTCMT = "requiresProductCmpt"; //$NON-NLS-1$
    String PROPERTY_MIN_INSTANCES = "minInstances"; //$NON-NLS-1$
    String PROPERTY_MAX_INSTANCES = "maxInstances"; //$NON-NLS-1$

    /**
     * Prefix for all message codes of this class.
     */
    String MSGCODE_PREFIX = "TESTPOLICYCMPTTYPEPARAMETER-"; //$NON-NLS-1$
     ...
     * instances.
     */
    String MSGCODE_MIN_INSTANCES_IS_GREATER_THAN_MAX = MSGCODE_PREFIX
     ...
     * instances.
     */
    String MSGCODE_MAX_INSTANCES_IS_LESS_THAN_MIN = MSGCODE_PREFIX + "MaxInstancesIsLessThanMin"; //$NON-NLS-1$
     ...
     */
    String MSGCODE_ASSOCIATION_NOT_EXISTS = MSGCODE_PREFIX + "AssociationNotExists"; //$NON-NLS-1$

    /**
     * Validation message code to indicate that the target of the association wasn't found.
     */
    String MSGCODE_TARGET_OF_ASSOCIATION_NOT_EXISTS = MSGCODE_PREFIX
     ...
     * association.
     */
    String MSGCODE_WRONG_POLICY_CMPT_TYPE_OF_ASSOCIATION = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_MUST_REQUIRE_PROD_IF_ROOT_AND_ABSTRACT = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_REQUIRES_PROD_BUT_POLICY_CMPT_TYPE_IS_NOT_CONF_BY_PROD = MSGCODE_PREFIX
     ...
     * type.
     */
    String MSGCODE_TARGET_OF_ASSOCIATION_NOT_EXISTS_IN_TESTCASETYPE = MSGCODE_PREFIX
     ...
     */
    void setPolicyCmptType(String pcType);
     ...
     * name exists.
     */
    ITestAttribute getTestAttribute(String attributeName);
     ...
     *            be based upon.
     */
    ITestAttribute[] getTestAttributes(String attributeName);
     ...
     */
    ITestPolicyCmptTypeParameter getTestPolicyCmptTypeParamChild(String name);
     ...
     */
    void setRequiresProductCmpt(boolean requiresProductCmpt);
     ...
     */
    void setMaxInstances(int manInstances);

    /**
     * Removes the given test policy component type parameter from the list of childs.
     */
    void removeTestPolicyCmptTypeParamChild(ITestPolicyCmptTypeParameter testPolicyCmptTypeParamChildName);
     ...
     */
    int[] moveTestAttributes(int[] indexes, boolean up);
     ...
     */
    int[] moveTestPolicyCmptTypeChild(int[] indexes, boolean up);
     ...
     */
    IIpsSrcFile[] getAllowedProductCmpt(IIpsProject ipsProjectToSearch, IProductCmpt parentProductCmpt)
            throws IpsException;
