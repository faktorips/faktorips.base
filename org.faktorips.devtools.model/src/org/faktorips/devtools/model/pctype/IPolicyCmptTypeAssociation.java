...
public interface IPolicyCmptTypeAssociation extends IAssociation {
     ...
     * otherwise <code>false</code>.
     * 
     * @throws CoreRuntimeException if an error occurs while searching for the derived union association.
     */
     ...
     */
    IPolicyCmptTypeAssociation findSharedAssociationHost(IIpsProject ipsProject) throws CoreRuntimeException;
