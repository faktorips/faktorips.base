...
public interface IProductCmpt extends IIpsMetaObject, ITimedIpsObject, IProductCmptLinkContainer,
     ...
     * 
     * @throws CoreRuntimeException if an exception occurs while accessing the project properties to get
     ...
     *            property values}
     * 
     * @throws CoreRuntimeException if an error occurs while searching for the {@link IProductCmptType
