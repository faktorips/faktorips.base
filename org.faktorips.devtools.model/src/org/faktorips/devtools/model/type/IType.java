...
public interface IType extends IIpsObject, Datatype, ILabeledElement, IVersionControlledElement {
     ...
     * 
     * @throws CoreRuntimeException If an exception occurs while collecting the attributes.
     */
     ...
     * added.
     * 
     * @throws CoreRuntimeException If an exception occurs while collecting the associations.
     */
     ...
     *            hierarchy.
     * @throws CoreRuntimeException If an exception occurs during the execution of this method.
     */
     ...
     * type.
     */
    public List<IAssociation> findConstrainableAssociationCandidates(IIpsProject ipsProject) throws CoreRuntimeException;
