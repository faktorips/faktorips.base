...
=== Version 21.12.5
When dividing `Decimal` value by `Decimal.NULL`, `Decimal.NULL` is now returned, as was previously documented in the Javadoc. (https://jira.faktorzehn.de/browse/FIPS-8989[FIPS-8989])
