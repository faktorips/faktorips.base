...
pipeline {
    ...
    post {
        always {
            parentReference referenceJob: "${JOB_NAME}", mergeBranch: 'hotfix/23.6',  targetBranch: '$GERRIT_BRANCH', latestBuildIfNotFound: false, latestCommitFallback: false, mergeOnlyJob: false, maxBuilds: 10, maxCommits: 500
