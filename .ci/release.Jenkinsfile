...
pipeline {
    ...
    parameters {
        ...
        gitParameter branch: '', branchFilter: 'origin\\/(main|hotfix/.+)', defaultValue: 'origin/hotfix/23.6', description: 'Der zu bauende Branch', name: 'BRANCH', quickFilterEnabled: false, selectedValue: 'NONE', sortMode: 'NONE', tagFilter: '*', type: 'GitParameterDefinition'
    }
