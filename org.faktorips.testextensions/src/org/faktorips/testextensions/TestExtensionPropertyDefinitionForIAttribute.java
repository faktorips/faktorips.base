...
public class TestExtensionPropertyDefinitionForIAttribute extends BooleanExtensionPropertyDefinition {

    public TestExtensionPropertyDefinitionForIAttribute() {
        super();
    }
    ...
    public static class BooleanExtensionPropertyEditFieldFactory implements IExtensionPropertyEditFieldFactory {
        ...
        public EditField<?> newEditField(IIpsObjectPartContainer ipsObjectPart,
                ...
                UIToolkit toolkit) {
            return new CheckboxField(toolkit.createCheckbox(extensionArea, "selected"));
        }
