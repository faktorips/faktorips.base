...
/**
 * Provides static factory methods to create a JAXBContext that can marshal / unmarshall all model classes defined
 * in a given runtime repository.
 * 
 * @see JAXBContext
...
public class JAXBContextFactory {
     ...
     * If the repository gives access to a class loader (e.g. ClassloaderRuntimeRepository does), the class loader provided
     * by the repository is taken. Otherwise the class loader that has loaded the class the repository is an instance of,
     * is used. 
     * 
