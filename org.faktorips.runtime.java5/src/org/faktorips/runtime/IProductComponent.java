...
public interface IProductComponent extends IRuntimeObject{
    ...
    /**
     * Returns the product component's id that uniquely identifies it in the repository
     * it belongs to.
     */
    public String getId();
    
    /**
     * Returns the id of the product component kind that this product component
     * belongs to.
     */
    ...
    /**
     * Returns the date when this product component expires. Returning <code>null</code>
     * means no end of the validity period.
     */
    public DateTime getValidTo();
    
    /**
     * Returns the generation that is effective on the given date or <code>null</code>
     * if no generation is effective on that date. 
     * 
