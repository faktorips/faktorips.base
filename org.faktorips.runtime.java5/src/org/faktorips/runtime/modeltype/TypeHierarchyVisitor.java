 ...
 * As we don't have an explizit type hierarchy class, not the typicall implementation with accept/visit methods,
 * but still a visitor.
 * 
 * @author Jan Ortmann
 */
public abstract class TypeHierarchyVisitor {
     ...
     * @return <code>true</code> if the visitor should continue to visit the supertypes, <code>false</code> if not.
     */
