...
public class ProductCmptGenerationNotFoundException extends RuntimeException {
     ...
     */
    public ProductCmptGenerationNotFoundException(
    ...
    /**
     * Returns <code>true</code> if the product component was found in the repository but the product component
     * hasn't got a generation valid at the given effective date. Returns <code>false</code> if the product component
     * hasn't been found.
     */
