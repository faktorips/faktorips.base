...
public abstract class ProductComponentGeneration extends RuntimeObject implements IProductComponentGeneration, IClRepositoryObject {
    ...
    /**
     * Returns a map containing the xml elements representing config elements found
     * in the indicated generation's xml element. For each config element the map contains
     * an entry with the pcTypeAttribute's name as key and the xml element containing the
     * config element data as value.
     * 
