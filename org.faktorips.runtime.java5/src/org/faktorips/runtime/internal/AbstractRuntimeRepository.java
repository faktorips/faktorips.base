...
public abstract class AbstractRuntimeRepository implements IRuntimeRepository {
     ...
     */
    protected abstract List<XmlAdapter<?, IEnumValue>> getAllInternalEnumXmlAdapters();
   
    /**
     * Adds all enumeration XmlAdapters available in this repository. These are the internal adapters
     * and the adapters specified by the enum value lookup services.
     * 
     ...
     */
    private void addAllEnumXmlAdapters(List<XmlAdapter<?, ? extends IEnumValue>> adapters) {
        adapters.addAll(getAllInternalEnumXmlAdapters());
    ...
    public JAXBContext newJAXBContext(JAXBContext ctx) {
        ...
        addAllEnumXmlAdapters(adapters);
        for (IRuntimeRepository runtimeRepository : getAllReferencedRepositories()) {
            AbstractRuntimeRepository refRepository = (AbstractRuntimeRepository)runtimeRepository;
            refRepository.addAllEnumXmlAdapters(adapters);
        }
