...
public abstract class AbstractReadonlyTableOfContents {
    ...
    /**
     * Returns the toc entry representing a product component for the given id or null if no
     * entry exists for the given id.
     */
    public abstract TocEntryObject getProductCmptTocEntry(String id);

    /**
     * Returns the toc entry representing a product component for the given product component kind id 
     * and versionId or null if no such entry exists.
     */
