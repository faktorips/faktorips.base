 ...
 */
public class SoftReferenceCache implements ICache {
    ...
    private Map<Object, SoftValue> hash;
    ...
    /*
     * Inner subclass of SoftReference which contains additional the
     * key to make it easier to find the entry in the map, after it has been garbage collected
     */
    private static class SoftValue extends SoftReference<Object> {
        private final Object key;
        private SoftValue(Object referent, Object key, ReferenceQueue<Object> q){
            super(referent, q);
            this.key = key;
        }
    }
    ...
    public SoftReferenceCache(int initialSize) {
        hash = new HashMap<Object, SoftValue>(initialSize);
    ...
    public Object getObject(Object key) {
        Object result = null;
        Reference<Object> ref = hash.get(key);
        if (ref != null) {
