...
public interface HtmlExportMessages {
    ...
    public static final String AssociationTablePageElement_headlineDescription = "AssociationTablePageElement_headlineDescription";
    public static final String AssociationTablePageElement_headlineLabel = "AssociationTablePageElement_headlineLabel";
    public static final String AssociationTablePageElement_headlineMaxCardinality = "AssociationTablePageElement_headlineMaxCardinality";
    public static final String AssociationTablePageElement_headlineMinCardinality = "AssociationTablePageElement_headlineMinCardinality";
    public static final String AssociationTablePageElement_headlineName = "AssociationTablePageElement_headlineName";
    public static final String AssociationTablePageElement_headlineQualified = "AssociationTablePageElement_headlineQualified";
    public static final String AssociationTablePageElement_headlineSubsettedDerivedUnion = "AssociationTablePageElement_headlineSubsettedDerivedUnion";
    ...
    public static final String MessageListTablePageElement_headlineProperties = "MessageListTablePageElement_headlineProperties";
    public static final String MessageListTablePageElement_headlineSeverity = "MessageListTablePageElement_headlineSeverity";
    ...
    public static final String ProductGenerationAttributeTable_notChangeable = "ProductGenerationAttributeTable_notChangeable";
    ...
    public static final String ProductGenerationAttributeTable_generationFrom = "ProductGenerationAttributeTable_generationFrom";
    public static final String ProductGenerationAttributeTable_minMaxStep = "ProductGenerationAttributeTable_minMaxStep";
    public static final String ProductGenerationAttributeTable_structure = "ProductGenerationAttributeTable_structure";
    public static final String ProductGenerationAttributeTable_tables = "ProductGenerationAttributeTable_tables";
    public static final String ProductGenerationAttributeTable_undefined = "ProductGenerationAttributeTable_undefined";
    ...
    public static final String AbstractTypeContentPageElement_hierarchy = "AbstractTypeContentPageElement_hierarchy";
    public static final String AbstractTypeContentPageElement_methods = "AbstractTypeContentPageElement_methods";
    public static final String AbstractTypeContentPageElement_noAssociations = "AbstractTypeContentPageElement_noAssociations";
    public static final String AbstractTypeContentPageElement_noAttributes = "AbstractTypeContentPageElement_noAttributes";
    public static final String AbstractTypeContentPageElement_noMethods = "AbstractTypeContentPageElement_noMethods";
    ...
    public static final String EnumTypeContentPageElement_noAttributes = "EnumTypeContentPageElement_noAttributes";
    public static final String EnumTypeContentPageElement_values = "EnumTypeContentPageElement_values";
    public static final String EnumTypeContentPageElement_noValues = "EnumTypeContentPageElement_noValues";
    public static final String EnumTypeContentPageElement_headlineDatatype = "EnumTypeContentPageElement_headlineDatatype";
    public static final String EnumTypeContentPageElement_headlineDescription = "EnumTypeContentPageElement_headlineDescription";
    public static final String EnumTypeContentPageElement_headlineIdentifier = "EnumTypeContentPageElement_headlineIdentifier";
    public static final String EnumTypeContentPageElement_headlineInherited = "EnumTypeContentPageElement_headlineInherited";
    ...
    public static final String TableStructureContentPageElement_noColumnRanges = "TableStructureContentPageElement_noColumnRanges";
    public static final String TableStructureContentPageElement_foreignKeys = "TableStructureContentPageElement_foreignKeys";
    public static final String TableStructureContentPageElement_fromColumn = "TableStructureContentPageElement_fromColumn";
    public static final String TableStructureContentPageElement_noForeignKeys = "TableStructureContentPageElement_noForeignKeys";
    public static final String TableStructureContentPageElement_name = "TableStructureContentPageElement_name";
    public static final String TableStructureContentPageElement_keyItems = "TableStructureContentPageElement_keyItems";
    public static final String TableStructureContentPageElement_referencedUniqueKey = "TableStructureContentPageElement_referencedUniqueKey";
    public static final String TableStructureContentPageElement_datatype = "TableStructureContentPageElement_datatype";
    public static final String TableStructureContentPageElement_description = "TableStructureContentPageElement_description";
    public static final String TableStructureContentPageElement_columns = "TableStructureContentPageElement_columns";
    public static final String TableStructureContentPageElement_noColumns = "TableStructureContentPageElement_noColumns";
    public static final String TableStructureContentPageElement_parameterName = "TableStructureContentPageElement_parameterName";
    ...
    public static final String TestCaseTypeContentPageElement_maxInstances = "TestCaseTypeContentPageElement_maxInstances";
    public static final String TestCaseTypeContentPageElement_minInstances = "TestCaseTypeContentPageElement_minInstances";
    public static final String TestCaseTypeContentPageElement_name = "TestCaseTypeContentPageElement_name";
    public static final String TestCaseTypeContentPageElement_noTestAttributes = "TestCaseTypeContentPageElement_noTestAttributes";
    public static final String TestCaseTypeContentPageElement_parameters = "TestCaseTypeContentPageElement_parameters";
    public static final String TestCaseTypeContentPageElement_requiresProductCmpt = "TestCaseTypeContentPageElement_requiresProductCmpt";
    public static final String TestCaseTypeContentPageElement_testAttributes = "TestCaseTypeContentPageElement_testAttributes";
    ...
    public static final String ProjectOverviewPageElement_noReferencedProjects = "ProjectOverviewPageElement_noReferencedProjects";
    public static final String ProjectOverviewPageElement_noReferencingProjects = "ProjectOverviewPageElement_noReferencingProjects";
    public static final String ProjectOverviewPageElement_noSourceFolder = "ProjectOverviewPageElement_noSourceFolder";
    public static final String ProjectOverviewPageElement_paths = "ProjectOverviewPageElement_paths";
    public static final String ProjectOverviewPageElement_project = "ProjectOverviewPageElement_project";
    public static final String ProjectOverviewPageElement_referencedProjects = "ProjectOverviewPageElement_referencedProjects";
