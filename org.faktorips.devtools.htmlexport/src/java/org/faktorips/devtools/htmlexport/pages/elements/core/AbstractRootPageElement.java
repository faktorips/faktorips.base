...
/**
 * {@link AbstractRootPageElement} is the abstract implementation of the root of
 * the page
 * 
 * @author dicker
 * 
...
public abstract class AbstractRootPageElement extends AbstractCompositePageElement {
	...
	/**
	 * @return path to the root (used for setting the right relative path in
	 *         links from the page
	 */
