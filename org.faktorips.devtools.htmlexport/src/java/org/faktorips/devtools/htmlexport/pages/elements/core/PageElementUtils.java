...
public class PageElementUtils {
	...
	/**
	 * creates {@link PageElement}s from the given {@link String}s with
	 * {@link Style}s and {@link TextType}s
	 * 
	 * @param texts
	 * @param styles
	 * @param type
	...
	/**
	 * creates a {@link List} with link to the given {@link IIpsObject}s with
	 * the given target and {@link Style}s
	 * 
	 * @param objects
	 * @param target
	 * @param styles
	 ...
	 */
	public static List<PageElement> createLinkPageElements(List<? extends IIpsObject> objects, String target,
			Set<Style> styles, DocumentorConfiguration config) {
	 ...
	 * @return
	 */
	public static PageElement createLinkPageElement(DocumentorConfiguration config, IIpsElement to, String target,
			String text, boolean useImage, Style... styles) {
