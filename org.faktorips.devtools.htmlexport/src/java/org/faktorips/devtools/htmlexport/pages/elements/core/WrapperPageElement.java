...
/**
 * {@link WrapperPageElement} represents element in complex structures like
 * tables, lists, trees e.g. listitems, tablerows etc.
 * 
 * @author dicker
 * 
 */
public class WrapperPageElement extends AbstractCompositePageElement {
	...
	/**
	 * creates an {@link WrapperPageElement} with the given {@link PageElement}s and the given styles
	 * @param wrapperType
	 * @param styles
	 * @param pageElements
	 */
