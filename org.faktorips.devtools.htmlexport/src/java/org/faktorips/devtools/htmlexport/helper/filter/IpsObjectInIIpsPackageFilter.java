...
/**
 * Filter, which checks, whether an {@link IpsObject} is within the given
 * {@link IpsPackageFragment} or the is within the {@link IpsPackageFragment}
 * with the same name of the given {@link IpsPackageFragment} (necessary for
 * {@link IpsObject}s in referenced {@link IpsProject}s
 * 
 * @author dicker
 * 
 */
public class IpsObjectInIIpsPackageFilter implements IpsElementFilter {
	 ...
	 * 
	 * @see
	 * org.faktorips.devtools.htmlexport.helper.filter.IpsElementFilter#accept
