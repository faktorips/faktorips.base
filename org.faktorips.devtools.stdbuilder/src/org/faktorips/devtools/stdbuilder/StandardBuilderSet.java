...
public class StandardBuilderSet extends DefaultBuilderSet {
    ...
    /**
     * Returns the package name for the artefacts generated by the given builder.
     * The builder MUST also implement the {@link IIpsStandardArtefactBuilder} interface.
     * 
     * @throws IllegalArgumentException if builder does not implement {@link IIpsStandardArtefactBuilder}
     * @throws NullPointerException if <code>builder</code> or <code>ipsSrcFile</code> is <code>null</code>.
     * @throws CoreException if an error occurs while accessing the ips object path.
     */
    public String getPackageNameForGeneratedArtefacts(IIpsArtefactBuilder builder, IIpsSrcFile ipsSrcFile) throws CoreException {
