...
public abstract class GenPolicyCmptTypeAttribute extends GenAttribute {
    ...
    /**
     * Convenience method that can be used by subclasses to add the method to the generated Java
     * elements.
     * 
     * @param javaElements The list to add the method to.
     * @param generatedJavaType The Java type that is generated by the builder this generator
     *            belongs to.
     * 
     * @throws NullPointerException If any parameter is <tt>null</tt>.
     */
    protected final void addGetSetOfAllowedValuesMethodToGeneratedJavaElements(List<IJavaElement> javaElements,
