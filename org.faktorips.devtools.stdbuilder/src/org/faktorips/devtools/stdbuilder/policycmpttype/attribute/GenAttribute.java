...
public abstract class GenAttribute extends GenPolicyCmptTypePart {
    ...
    protected final String memberVarName;
    ...
    @Override
    public final void getGeneratedJavaElements(List<IJavaElement> javaElements,
            IType generatedJavaType,
            IIpsObjectPartContainer ipsObjectPartContainer,
            boolean forInterface) {

        if (forInterface) {
            getGeneratedJavaElementsForPublishedInterface(javaElements, generatedJavaType);
        } else {
    ...
    /**
     * Adds the <tt>IJavaElement</tt>s that this generator generates for the published interface to
     * the given list.
     * <p>
     * Subclasses may overwrite but must not forget to call this implementation.
     * 
     * @param javaElements The list to add the generated <tt>IJavaElement</tt>s to.
     * @param generatedJavaType The Java type that is generated by the builder this generator
     *            belongs to.
     * 
    ...
    /**
     * Adds the <tt>IJavaElement</tt>s that this generator generates for the implementation to the
     * given list.
     * <p>
     * Subclasses may overwrite but must not forget to call this implementation.
     * 
