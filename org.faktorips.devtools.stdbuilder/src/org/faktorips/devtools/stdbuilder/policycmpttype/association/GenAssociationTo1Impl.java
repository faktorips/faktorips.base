 ...
 * @author Jan Ortmann
 */
public class GenAssociationTo1Impl extends GenAssociationTo1 {

    public GenAssociationTo1Impl(IPolicyCmptTypeAssociation association, PolicyCmptImplClassBuilder builder,
    ...
    public JavaCodeFragment generateCodeToSynchronizeReverseAssoziation(
        ...
        if (reverseAssociation.is1ToMany()) {
            toManyGenerator = new GenAssociationToManyImpl(reverseAssociation, (PolicyCmptImplClassBuilder)getJavaSourceFileBuilder(), new LocalizedStringsSet(GenAssociation.class));
        }
