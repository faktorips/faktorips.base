...
public class ValidatedByAnnGenFactory implements IAnnotationGeneratorFactory {
    ...
    public IAnnotationGenerator createAnnotationGenerator(AnnotatedJavaElementType type) {
        if (type == AnnotatedJavaElementType.POLICY_CMPT_IMPL_CLASS) {
            return new ValidatedByAnnGen();
        } else {
            return null;
        }
    }
