 ...
 * generated by the code generator for the <tt>IIpsObjectPartContainer</tt> to be refactored.
 * 
...
public class RenameRefactoringParticipant extends RenameParticipant {
    ...
    private class RenameParticipantHelper extends RefactoringParticipantHelper {
        ...
        /**
         * Overridden to add extra functionality in case an <tt>IPolicyCmptTypeAttribute</tt> or
        ...
        /**
         * For <tt>IPolicyCmptTypeAttribute</tt>s that are overwritten it's necessary to add the
         * Java elements generated by the original attribute.
         */
