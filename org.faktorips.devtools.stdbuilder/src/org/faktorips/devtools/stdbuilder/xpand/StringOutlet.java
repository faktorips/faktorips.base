...
/**
 * This implementation of {@link Outlet} handles String output instead of file outputs.
 * 
 * @author dirmeier
 */
public class StringOutlet extends Outlet {
    ...
    private final Map<IPath, StringHandle> stringHandles = new HashMap<IPath, StringHandle>();
    ...
    public FileHandle createFileHandle(final String filePath) throws VetoException {
        StringHandle stringHandle = new StringHandle(this, filePath, getFileEncoding());
