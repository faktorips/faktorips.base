...
import org.faktorips.devtools.stdbuilder.xpand.enumtype.model.XEnumValue
...
import static extension org.faktorips.devtools.stdbuilder.xpand.enumtype.template.CommonEnumTypeTmpl.*
...
class ClassEnumTypeTmpl {
    ...
    def static String body(XEnumType it) '''
        ...
        */
        ...
        public final class «name» «CommonDefinitionsTmpl::extendedInterfaces(it)» «CommonDefinitionsTmpl::implementedInterfaces(it)»{
