...
public class XpandProductCmptAdjBuilder extends XpandBuilder {

    public XpandProductCmptAdjBuilder(StandardBuilderSet builderSet) {
        super(builderSet, new LocalizedStringsSet(XpandProductCmptAdjBuilder.class));
    }
