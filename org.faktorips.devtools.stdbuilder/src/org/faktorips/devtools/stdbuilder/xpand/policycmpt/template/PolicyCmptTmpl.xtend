...
import org.faktorips.devtools.stdbuilder.xpand.template.DerivedUnionAssociationTmpl
...
def static  String body (XPolicyCmptClass it) '''
    ...
    public «CommonGeneratorExtensionsTmpl::isAbstract(it)» class «implClassName» extends «superclassName» «CommonDefinitionsTmpl.implementedInterfaces(it)»{
