...
VALUETYPES_JODA_LIB_JAVADOC_JAR=$DIR/fake-java-doc/$VALUETYPES_JODA_LIB.javadoc.jar
#VALUETYPES_JODA_LIB_JAVADOC_JAR=`ls $JAR_DIRECTORY/$VALUETYPES_JODA_LIB.javadoc_*.jar`
VALUETYPES_JODA_LIB_POM=$DIR/nexus-poms/valuetypes.joda-pom.xml
...
echo "********"
echo $VALUETYPES_JODA_ARTIFACT_ID
