...
public class PlainJavaImplementationTest {
    ...
    public void testGetId() {
        assertThat(PlainJavaImplementation.get().getId(), is("Plain Java Faktor-IPS"));
    }
    ...
    public void testGetWorkspace_CreatesWorkspace() throws IOException {
        ...
        try {
            ...
            assertThat(tmpDir.getName(), containsString("Workspace"));
        } finally {
            if (tmpDir != null) {
                FileUtils.deleteDirectory(tmpDir);
            }
    ...
    public void testGetVersion() {
        assertThat(PlainJavaImplementation.get().getVersion(), is(AVersion.parse("21.12")));
    }
    ...
    public void testLog() {
        ...
        Status status1 = new Status(IStatus.ERROR, "foo1", "bar1");
        Status status2 = new Status(IStatus.WARNING, "foo2", "bar2");
        Status status3 = new Status(IStatus.INFO, "foo3", "bar3");
        Status status4 = new Status(IStatus.OK, "foo4", "bar4");
        ...
        assertThat(logged.get(Level.SEVERE), is("bar1"));
        assertThat(logged.get(Level.WARNING), is("bar2"));
        assertThat(logged.get(Level.INFO), is("bar3"));
        assertThat(logged.get(Level.FINE), is("bar4"));
    }
