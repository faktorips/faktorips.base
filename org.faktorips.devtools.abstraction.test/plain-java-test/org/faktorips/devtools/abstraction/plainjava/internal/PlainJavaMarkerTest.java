...
public class PlainJavaMarkerTest extends PlainJavaAbstractionTestSetup {
    ...
    public void testGetAttribute() {
        ...
        assertThat(marker.getAttribute(PlainJavaMarkerImpl.SEVERITY, "marker_is_not_string_return_this_string"),
    ...
    public void testSetAttributes_NullValues() {
        ...
        marker.setAttributes(new String[] { "Key1" }, null);
    }
    ...
    public void testSetAttributes_MissmatchAttributesToValues() {
        ...
        marker.setAttributes(new String[] { "Key1" }, new Object[] { "Val1", "Val2" });
    }
