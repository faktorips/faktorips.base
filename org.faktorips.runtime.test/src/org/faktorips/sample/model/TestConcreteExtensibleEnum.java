...
public final class TestConcreteExtensibleEnum
	...
	public static final TestConcreteExtensibleEnum CLASS_VALUE_2 = new TestConcreteExtensibleEnum(1, "C2",
			"Class Value 2");
	/**
	 * Konstante für alle Werte die im Aufzählungstyp definiert wurden. Die Werte
	 * könnten durch weitere Werte aus dem Runtime Repository ergänzt werden.
	 *
	 * @generated
	 */
