...
public interface IAssociation extends ITypePart {
    ...
    String PROPERTY_ASSOCIATION_TYPE = "associationType"; //$NON-NLS-1$
    String PROPERTY_AGGREGATION_KIND = "aggregationKind"; //$NON-NLS-1$
    String PROPERTY_TARGET = "target"; //$NON-NLS-1$
    String PROPERTY_TARGET_ROLE_SINGULAR = "targetRoleSingular"; //$NON-NLS-1$
    String PROPERTY_TARGET_ROLE_PLURAL = "targetRolePlural"; //$NON-NLS-1$
    String PROPERTY_MIN_CARDINALITY = "minCardinality"; //$NON-NLS-1$
    String PROPERTY_MAX_CARDINALITY = "maxCardinality"; //$NON-NLS-1$
    String PROPERTY_DERIVED_UNION = "derivedUnion"; //$NON-NLS-1$
    String PROPERTY_SUBSETTED_DERIVED_UNION = "subsettedDerivedUnion"; //$NON-NLS-1$
    String PROPERTY_QUALIFIED = "qualified"; //$NON-NLS-1$
    String PROPERTY_CONSTRAIN = "constrain"; //$NON-NLS-1$

    /**
     * Prefix for all message codes of this class.
     */
    String MSGCODE_PREFIX = "Association-"; //$NON-NLS-1$

    /**
     * Validation message code to indicate that the target does not exist.
     */
    String MSGCODE_TARGET_DOES_NOT_EXIST = MSGCODE_PREFIX + "TargetDoesNotExists"; //$NON-NLS-1$

    /**
     * Validation message code to indicate that the target role singular must be set and it's not.
     */
    String MSGCODE_TARGET_ROLE_SINGULAR_MUST_BE_SET = MSGCODE_PREFIX
     ...
     * associations.
     */
    String MSGCODE_TARGET_ROLE_PLURAL_MUST_BE_SET = MSGCODE_PREFIX + "TargetRolePluralMustBeSet"; //$NON-NLS-1$

    /**
     * Validation message code to indicate that the max cardinality must be at least 1 and it's not.
     */
    String MSGCODE_MAX_CARDINALITY_MUST_BE_AT_LEAST_1 = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_MAX_CARDINALITY_FOR_DERIVED_UNION_TOO_LOW = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_MAX_IS_LESS_THAN_MIN = MSGCODE_PREFIX + "MaxIsLessThanMin"; //$NON-NLS-1$
     ...
     */
    String MSGCODE_DERIVED_UNION_NOT_FOUND = MSGCODE_PREFIX + "DerivedUnionNotFound"; //$NON-NLS-1$

    /**
     * Validation message code to indicate that the association that is constrained with target role
     * singular can't be found.
     */
    String MSGCODE_CONSTRAINED_SINGULAR_NOT_FOUND = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_CONSTRAINED_TARGET_SUPERTYP_NOT_COVARIANT = MSGCODE_PREFIX
            + "ConstrainedwithTargetSupertypeNotConvenient"; //$NON-NLS-1$
    /**
     * Validation message code to indicate that the association that is constrained with target role
     * plural can't be found.
     */
    String MSGCODE_CONSTRAINED_PLURAL_NOT_FOUND = MSGCODE_PREFIX + "ConstrainedwithPluralNotFound"; //$NON-NLS-1$

    /**
     * Validation message code to indicate that this association is marked as subset of a derived
     * union.
     */
    String MSGCODE_CONSTRAIN_SUBSET_DERIVED_UNION = MSGCODE_PREFIX + "ConstrainSubsetDerivedUnion"; //$NON-NLS-1$

    /**
     * Validation message code to indicate that this association is marked as a derived union.
     */
    String MSGCODE_CONSTRAIN_DERIVED_UNION = MSGCODE_PREFIX + "ConstrainDerivedUnion"; //$NON-NLS-1$

    /**
     * Validation message code to indicate that overwritten association is marked as subset of a
     * derived union.
     */
    String MSGCODE_CONSTRAINED_SUBSET_DERIVED_UNION = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_MAX_CARDINALITY_NOT_VALID_CONSTRAINT_FOR_SUPER_ASSOCIATION = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_MIN_CARDINALITY_NOT_VALID_CONSTRAINT_FOR_SUPER_ASSOCIATION = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_ASSOCIATION_TYPE_NOT_EQUAL_TO_SUPER_ASSOCIATION = MSGCODE_PREFIX
     ...
     * union.
     */
    String MSGCODE_CONSTRAINED_DERIVED_UNION = MSGCODE_PREFIX + "ConstraintedDerivedUnion"; //$NON-NLS-1$
     ...
     */
    String MSGCODE_NOT_MARKED_AS_DERIVED_UNION = MSGCODE_PREFIX + "NotMarkedAsDerivedUnion"; //$NON-NLS-1$
     ...
     * derived union.
     */
    String MSGCODE_TARGET_OF_DERIVED_UNION_DOES_NOT_EXIST = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_DERIVED_UNION_SUBSET_NOT_SAME_AS_DERIVED_UNION = MSGCODE_PREFIX
            + "DerivedUnionSubsetNotSameAsDerivedUnion"; //$NON-NLS-1$

    /**
     * Validation message code that indicates that a derived union cannot be its own subset.
     */
    String MSGCODE_SUBSET_OF_DERIVED_UNION_SAME_MAX_CARDINALITY = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_TARGET_TYPE_NOT_A_SUBTYPE = IPolicyCmptTypeAssociation.MSGCODE_PREFIX
     ...
     */
    String MSGCODE_TARGET_ROLE_SINGULAR_NOT_A_VALID_JAVA_FIELD_NAME = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_TARGET_ROLE_PLURAL_NOT_A_VALID_JAVA_FIELD_NAME = MSGCODE_PREFIX
            + "TargetRolePluralNotAValidJavaFieldName"; //$NON-NLS-1$

    AssociationType DEFAULT_RELATION_TYPE = AssociationType.ASSOCIATION;
     ...
     */
    void setDerivedUnion(boolean flag);
     ...
     * @see #isConstrain()
     */
    void setConstrain(boolean constrains);

    /**
     * Sets the derived union association that is subsetted by this association.
     */
    void setSubsettedDerivedUnion(String newDerivedUnion);
     ...
     */
    IAssociation findSuperAssociationWithSameName(IIpsProject ipsProject);
     ...
     */
    IAssociation findConstrainedAssociation(IIpsProject ipsProject);
