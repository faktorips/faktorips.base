...
public class ValidationUtils {
     ...
     * 
     * @see PlainJavaConventions#validateName(String, Runtime.Version)
     */
    public static boolean validateFieldName(String name, IIpsProject ipsProject) {
        ...
        boolean isValidFieldName = PlainJavaConventions.validateName(StringUtils.capitalize(name),
                sourceVersion);
        if (isValidFieldName) {
            return PlainJavaConventions.validateName(StringUtils.uncapitalize(name),
                    sourceVersion);
        } else {
     ...
     * 
     * @see PlainJavaConventions#validateTypeName(String)
     */
    ...
    public static boolean validateJavaIdentifier(String name, IIpsProject ipsProject) {
        Runtime.Version sourceVersion = ipsProject.getJavaProject().getSourceVersion();
        return PlainJavaConventions.validateName(name, sourceVersion);
    }
