...
public interface ITableContents extends IIpsMetaObject, XmlSaxSupport {
    ...
    String PROPERTY_NUMOFCOLUMNS = "numOfColumns"; //$NON-NLS-1$

    /**
     * Prefix for all message codes of this class.
     */
    String MSGCODE_PREFIX = "TABLECONTENTS-"; //$NON-NLS-1$
     ...
     */
    String MSGCODE_UNIQUE_KEY_VIOLATION = MSGCODE_PREFIX + "UniqueKeyViolation"; //$NON-NLS-1$
    ...
    String MSGCODE_TWO_COLUMN_RANGE_FROM_GREATER_TO_VALUE = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_TOO_MANY_UNIQUE_KEY_VIOLATIONS = MSGCODE_PREFIX + "TooManyUniqueKeyViolations"; //$NON-NLS-1$

    /**
     * Validation message code to indicate that there are to many contents for a single content
     * table structure.
     */
    String MSGCODE_TOO_MANY_CONTENTS_FOR_SINGLETABLESTRUCTURE = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_TABLE_CONTENTS_REFERENCED_COLUMN_ORDERING_INVALID = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_TABLE_CONTENTS_REFERENCED_COLUMNS_COUNT_INVALID = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_TABLE_CONTENTS_REFERENCED_COLUMN_NAMES_INVALID = MSGCODE_PREFIX
     ...
     */
    String MSGCODE_DEPRECATED_TABLE_STRUCTURE = MSGCODE_PREFIX + "DeprecatedTableStructure"; //$NON-NLS-1$
     ...
     */
    void setTableStructure(String qName);
     ...
     */
    ITableStructure findTableStructure(IIpsProject ipsProject) throws IpsException;
     ...
     */
    int newColumn(String defaultValue, String name);
     ...
     * @param name the name of the new column
     */
    void newColumnAt(int index, String defaultValue, String name);
     ...
     */
    void createColumnReferenceSaxHandler(String referenceID);
