 ...
 * </copyright>
 *
 * $Id: JInitializer.java,v 1.1 2006/01/18 20:42:16 marcelop Exp $
 */
package org.eclipse.emf.codegen.merge.java.facade;

/**
 * Represents an initializer. The corresponding syntactic units are InstanceInitializer (JLS2 8.6)
 * and StaticDeclaration (JLS2 8.7). An initializer has no children and its parent is a type.
 * 
 * @since 2.2.0
 */
public interface JInitializer extends JMember {
     ...
     *
     * @return an initializer body, including braces, or <code>null</code> if no body is present
     */
    String getBody();
