...
public final class FacadeFlags {
    ...
    /**
     * Bridge method property flag (added in J2SE 1.5). Used to flag a compiler-generated bridge
     * methods. See The Java Virtual Machine Specification for more details.
     */
    public static final int BRIDGE = 0x0040;

    /**
     * Varargs method property flag (added in J2SE 1.5). Used to flag variable arity method
     * declarations. See The Java Virtual Machine Specification for more details.
     */
    public static final int VARARGS = 0x0080;

    /**
     * Enum property flag (added in J2SE 1.5). See The Java Virtual Machine Specification for more
     * details.
     */
    public static final int ENUM = 0x4000;

    /**
     * Annotation property flag (added in J2SE 1.5). See The Java Virtual Machine Specification for
     * more details.
     */
     ...
     * <code>@deprecated</code> tag in Javadoc comment).
     *
     * @param flags the flags
    ...
    /**
     * Returns a standard string describing the given modifier flags. Only modifier flags are
     * included in the output; deprecated, synthetic, bridge, etc. flags are ignored.
     * <p>
     ...
     * description. Since the AccVarargs flag has the same value as the AccTransient flag (valid for
     * fields only), attempting to get the description of method modifiers with the AccVarargs flag
     * set would result in an unexpected description. Clients should ensure that the AccVarargs is
     * not included in the flags of a method as follows:
     * 
     * <pre>
     * IMethod method = ...
