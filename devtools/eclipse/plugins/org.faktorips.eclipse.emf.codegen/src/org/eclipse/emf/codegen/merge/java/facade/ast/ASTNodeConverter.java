...
public class ASTNodeConverter implements NodeConverter {
    ...
    protected class TypeToEnumConverter extends Converter {
         ...
         * enum constants. Arguments of the enum constants are set from arguments of the
         * initializer. Arguments that match the name of any other field are replaced by initializer
         * value of that field.
         * <p>
         ...
         * <p>
         * Field must be declared as <code>public static final</code> field, and field must be of
         * the same type as its parent (e.g. type).
         * <p>
         ...
         * <p>
         * Note that the original field's initializer node structure is used (e.g. if
         * {@link ASTJField#setInitializer(String)} has been called, this method will use the
         * original initializer of the field).
         * 
         * @param enumConstant
         * @param field
         */
    ...
    protected class EnumToTypeConverter extends Converter {
         ...
         * to public static final fields with initializer value created from arguments and body of
         * enum constant.
         * 
         * @return converted type, or <code>null</code> if conversion not possible
         * 
         ...
         * <p>
         * Resulting field is <code>public static final</code>. The type of the field is the name of
         * the enum. Comment of the field is copied from the enum constant. Initializer value is a
         * call to the constructor of the enum (or converted type) with arguments taken from enum
         * constant.
         * 
         * @see #setFieldInitializer(ASTJField, ASTJEnumConstant)
         * 
         ...
         * <li><code>ArgumentsList</code> is the arguments of the enum constant with some arguments
         * replaced by the names of static final fields. Arguments that match the initializer value
        ...
        protected void setFieldInitializer(ASTJField field, ASTJEnumConstant enumConstant) {
            ...
            field.setNodeProperty(classInstanceCreation, enumConstant.getParent().getName(),
                    ClassInstanceCreation.TYPE_PROPERTY, ASTNode.SIMPLE_TYPE);
            ...
            if (arguments != null) {
                ...
                field.setListNodeProperty(classInstanceCreation, arguments, ClassInstanceCreation.ARGUMENTS_PROPERTY,
                        ASTNode.SIMPLE_NAME);
            }
            ...
            field.setNodeProperty(field.getVariableDeclarationFragment(), classInstanceCreation,
