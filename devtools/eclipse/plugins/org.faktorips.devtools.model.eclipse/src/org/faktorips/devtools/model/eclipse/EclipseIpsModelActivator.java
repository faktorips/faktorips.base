...
import org.faktorips.devtools.model.eclipse.builder.DependencyGraphPersistenceManager;
...
public class EclipseIpsModelActivator implements BundleActivator {
    ...
    /** The shared instance. */
    private static EclipseIpsModelActivator activator;

    private Bundle bundle;

    private DependencyGraphPersistenceManager dependencyGraphPersistenceManager;

    public EclipseIpsModelActivator() {
        activator = this;
    }

    public static EclipseIpsModelActivator get() {
     ...
     * 
     *             TODO Investigate the usage of a service factory (see also
