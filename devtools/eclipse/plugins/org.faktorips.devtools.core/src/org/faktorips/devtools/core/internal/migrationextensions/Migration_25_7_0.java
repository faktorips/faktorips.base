...
public class Migration_25_7_0 extends MarkAsDirtyMigration {
    ...
    private static final String VERSION = "25.7.0"; //$NON-NLS-1$

    public Migration_25_7_0(IIpsProject projectToMigrate, String featureId) {
     ...
     */
    Migration_25_7_0(IIpsProject projectToMigrate, String featureId, String migrationVersion) {
    ...
    public static class Factory implements IIpsProjectMigrationOperationFactory {
        ...
        public AbstractIpsProjectMigrationOperation createIpsProjectMigrationOpertation(IIpsProject ipsProject,
                String featureId) {
            return new Migration_25_7_0(ipsProject, featureId);
        }
    }
}
