...
public class ContextProductCmptFinder {
    ...
    protected AbstractProductCmptCollector createCollector() {
        ...
        return switch (node) {
            case AssociationNode associationNode -> new AssociationCollector(associationNode, this);
            case ParameterNode parameterNode -> new ParameterCollector(parameterNode, this);
            case QualifierNode qualifierNode -> new QualifierCollector(qualifierNode, this);
            case null, default -> new DefaultCollector(node, this);
        };
    }
