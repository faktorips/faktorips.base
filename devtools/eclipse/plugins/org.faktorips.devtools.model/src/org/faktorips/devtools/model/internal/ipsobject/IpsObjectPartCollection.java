...
public class IpsObjectPartCollection<T extends IIpsObjectPart> implements Iterable<T> {
    ...
    /**
     * An implementations of this interface is required by the
     * {@link IpsObjectPartCollection#newPart(Class)} method. It is supposed to be used for
     * additional initialization of a new {@link IpsObjectPart} before its creation and addition to
     * the according {@link IpsObject} is communicated to {@link ContentsChangeListener
