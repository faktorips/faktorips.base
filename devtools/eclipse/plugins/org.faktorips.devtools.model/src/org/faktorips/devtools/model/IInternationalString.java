...
public interface IInternationalString extends XmlSupport, Comparable<IInternationalString> {
    ...
    /**
     * Removes the {@link LocalizedString} for the given locale from this
     * {@link IInternationalString}.
     *
     * @param locale The locale for which the {@link LocalizedString} should be removed
     * @return The removed {@link LocalizedString} or {@code null} if no entry existed for the given
     *             locale
     */
    LocalizedString remove(Locale locale);
