...
public class Messages extends IpsNLS {
    ...
    private static final String BUNDLE_NAME = "org.faktorips.devtools.model.internal.util.messages"; //$NON-NLS-1$
    ...
    public static String StringUtils_copyOfNamePrefix;
