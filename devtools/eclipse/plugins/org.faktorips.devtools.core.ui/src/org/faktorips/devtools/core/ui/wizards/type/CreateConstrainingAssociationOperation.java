 ...
 * constrained association has an inverse association and the target type is actually changed. If
 * the target type is unchanged, the existing inverse association of the constrained association
 * remains valid and is not touched.</li>
 * </ul>
