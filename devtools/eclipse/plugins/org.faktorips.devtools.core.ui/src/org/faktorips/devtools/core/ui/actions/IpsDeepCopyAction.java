...
public class IpsDeepCopyAction extends IpsAction {
    ...
    public IpsDeepCopyAction(Shell shell, ISelectionProvider selectionProvider, int type) {
        ...
        if (type == DeepCopyWizard.TYPE_COPY_PRODUCT) {
            ...
            setImageDescriptor(IpsUIPlugin.getImageHandling().createImageDescriptor("DeepCopyWizard.svg")); //$NON-NLS-1$
        } else {
            ...
            setImageDescriptor(IpsUIPlugin.getImageHandling().createImageDescriptor("NewVersionWizard.svg")); //$NON-NLS-1$
        }
    }
