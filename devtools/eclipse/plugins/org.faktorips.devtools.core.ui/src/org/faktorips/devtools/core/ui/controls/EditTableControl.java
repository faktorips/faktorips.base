...
public abstract class EditTableControl extends Composite implements IDataChangeableReadWriteAccess {
    ...
    private void createButtonComposite(Composite parent) {
        ...
        upButton = createMoveButton(buttonComposite, Messages.EditTableControlUIBuilder_UpButtonLabel, true);
        downButton = createMoveButton(buttonComposite, Messages.EditTableControlUIBuilder_DownButtonLabel, false);
    ...
    private Button createAddButton(Composite buttonComposite) {
        ...
        button.setText(Messages.EditTableControlUIBuilder_AddButtonLabel);
    ...
    private Button createRemoveButton(Composite buttonComposite) {
        ...
        button.setText(Messages.EditTableControlUIBuilder_RemoveButtonLabel);
        button.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
