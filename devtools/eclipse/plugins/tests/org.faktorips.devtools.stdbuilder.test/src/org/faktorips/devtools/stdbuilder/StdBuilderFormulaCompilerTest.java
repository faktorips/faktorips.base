...
public class StdBuilderFormulaCompilerTest extends XmlAbstractTestCase {
    private StandardBuilderSet builderSet;
    private IIpsProject ipsProject;
    private GeneratorModelContext generatorModelContext;
    private Document document;
    private Element element;
    private StdBuilderFormulaCompiler compiler;

    @Before
    public void setUp() throws Exception {
        builderSet = mock(StandardBuilderSet.class);
        ...
        compiler = new StdBuilderFormulaCompiler();
    }
