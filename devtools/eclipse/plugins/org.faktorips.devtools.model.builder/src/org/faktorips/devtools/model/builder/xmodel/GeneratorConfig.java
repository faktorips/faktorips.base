 ...
 * {@link JavaBuilderSet} properties.
 */
public class GeneratorConfig {
    ...
    /**
     * Returns the {@link GeneratorConfig} from the {@link JavaBuilderSet} associated with the given
     * object's {@link IIpsPackageFragmentRoot}.
     *
    ...
    /**
     * Returns the {@link GeneratorConfig} from the {@link JavaBuilderSet} associated with the given
     * file's {@link IIpsPackageFragmentRoot}.
     *
    ...
    public boolean isGenerateChangeSupport() {
        return config.getPropertyValueAsBoolean(JavaBuilderSet.CONFIG_PROPERTY_GENERATE_CHANGELISTENER)
                .booleanValue();
    }

    public FormulaCompiling getFormulaCompiling() {
        String kind = config.getPropertyValueAsString(JavaBuilderSet.CONFIG_PROPERTY_FORMULA_COMPILING);
        try {
     ...
     *
     * @see JavaBuilderSet#CONFIG_PROPERTY_UNIFY_VALUE_SET_METHODS
     */
    public ValueSetMethods getValueSetMethods() {
        String kind = config.getPropertyValueAsString(JavaBuilderSet.CONFIG_PROPERTY_UNIFY_VALUE_SET_METHODS);
        try {
     ...
     *
     * @see JavaBuilderSet#CONFIG_PROPERTY_CAMELCASE_SEPARATED
     */
    public boolean isGenerateSeparatedCamelCase() {
        Boolean propertyValueAsBoolean = config
                .getPropertyValueAsBoolean(JavaBuilderSet.CONFIG_PROPERTY_CAMELCASE_SEPARATED);
        return propertyValueAsBoolean == null ? false : propertyValueAsBoolean.booleanValue();
    }

    public boolean isGenerateDeltaSupport() {
        Boolean propertyValueAsBoolean = config
                .getPropertyValueAsBoolean(JavaBuilderSet.CONFIG_PROPERTY_GENERATE_DELTA_SUPPORT);
        return propertyValueAsBoolean == null ? false : propertyValueAsBoolean;
    }

    public boolean isGenerateCopySupport() {
        Boolean propertyValueAsBoolean = config
                .getPropertyValueAsBoolean(JavaBuilderSet.CONFIG_PROPERTY_GENERATE_COPY_SUPPORT);
        return propertyValueAsBoolean == null ? false : propertyValueAsBoolean;
    }

    public boolean isGenerateVisitorSupport() {
        Boolean propertyValueAsBoolean = config
                .getPropertyValueAsBoolean(JavaBuilderSet.CONFIG_PROPERTY_GENERATE_VISITOR_SUPPORT);
        return propertyValueAsBoolean == null ? false : propertyValueAsBoolean;
    }

    public boolean isGenerateToXmlSupport() {
        Boolean propertyValueAsBoolean = config
                .getPropertyValueAsBoolean(JavaBuilderSet.CONFIG_PROPERTY_TO_XML_SUPPORT);
        return propertyValueAsBoolean == null ? false : propertyValueAsBoolean;
    }
    ...
    private boolean isGeneratePublishedInterfaces(IIpsArtefactBuilderSetConfig config) {
        Boolean propertyValueAsBoolean = config
                .getPropertyValueAsBoolean(JavaBuilderSet.CONFIG_PROPERTY_PUBLISHED_INTERFACES);
    ...
    public boolean isGenerateSerializablePolicyCmptSupport() {
        Boolean propertyValueAsBoolean = config.getPropertyValueAsBoolean(
                JavaBuilderSet.CONFIG_PROPERTY_GENERATE_SERIALIZABLE_POLICY_CMPTS_SUPPORT);
        return propertyValueAsBoolean == null ? false : propertyValueAsBoolean;
    }

    public boolean isGenerateConvenienceGetters() {
        Boolean propertyValueAsBoolean = config
                .getPropertyValueAsBoolean(JavaBuilderSet.CONFIG_PROPERTY_GENERATE_CONVENIENCE_GETTERS);
        return propertyValueAsBoolean == null ? true : propertyValueAsBoolean;
    }

    public boolean isGeneratePolicyBuilder() {
        String propertyValue = config.getPropertyValueAsString(JavaBuilderSet.CONFIG_PROPERTY_BUILDER_GENERATOR);
        return (JavaBuilderSet.CONFIG_PROPERTY_BUILDER_GENERATOR_ALL.equals(propertyValue)
                || JavaBuilderSet.CONFIG_PROPERTY_BUILDER_GENERATOR_POLICY.equals(propertyValue));
    }

    public boolean isGenerateProductBuilder() {
        String propertyValue = config.getPropertyValueAsString(JavaBuilderSet.CONFIG_PROPERTY_BUILDER_GENERATOR);
        return (JavaBuilderSet.CONFIG_PROPERTY_BUILDER_GENERATOR_ALL.equals(propertyValue)
                || JavaBuilderSet.CONFIG_PROPERTY_BUILDER_GENERATOR_PRODUCT.equals(propertyValue));
    }

    public boolean isGenerateGetEffectiveFromAsCalendar() {
        Boolean propertyValueAsBoolean = config
                .getPropertyValueAsBoolean(JavaBuilderSet.CONFIG_PROPERTY_GENERATE_GET_EFFECTIVE_FROM_AS_CALENDAR);
        return propertyValueAsBoolean == null ? true : propertyValueAsBoolean.booleanValue();
    }

    public String getBaseClassPolicyCmptType() {
        String baseClass = config
                .getPropertyValueAsString(JavaBuilderSet.CONFIG_PROPERTY_BASE_CLASS_POLICY_CMPT_TYPE);
    ...
    public String getBaseClassProductCmptType() {
        String baseClass = config
                .getPropertyValueAsString(JavaBuilderSet.CONFIG_PROPERTY_BASE_CLASS_PRODUCT_CMPT_TYPE);
    ...
    public IChangesOverTimeNamingConvention getChangesOverTimeNamingConvention() {
        String changesOverTimeNamingConventionId = config
                .getPropertyValueAsString(JavaBuilderSet.CONFIG_PROPERTY_CHANGES_OVER_TIME_NAMING_CONVENTION);
    ...
    public JaxbSupportVariant getJaxbSupport() {
        return JaxbSupportVariant
                .of(config.getPropertyValueAsString(JavaBuilderSet.CONFIG_PROPERTY_GENERATE_JAXB_SUPPORT));
    }
    ...
    public Locale getLanguageUsedInGeneratedSourceCode() {
        String localeString = config.getPropertyValueAsString(JavaBuilderSet.CONFIG_PROPERTY_GENERATOR_LOCALE);
    ...
    public String getConfiguredAdditionalAnnotations() {
        return getStringProperty(JavaBuilderSet.CONFIG_PROPERTY_ADDITIONAL_ANNOTATIONS, IpsStringUtils.EMPTY);
    }

    /**
     * @since 26.7
     */
    public String getConfiguredAdditionalAnnotationsForFields() {
        return getStringProperty(JavaBuilderSet.CONFIG_PROPERTY_ADDITIONAL_ANNOTATIONS_FOR_FIELDS,
    ...
    public String getAdditionalAnnotationsLocation() {
        return config.getPropertyValueAsString(JavaBuilderSet.CONFIG_PROPERTY_ADDITIONAL_ANNOTATIONS_LOCATION);
    }
