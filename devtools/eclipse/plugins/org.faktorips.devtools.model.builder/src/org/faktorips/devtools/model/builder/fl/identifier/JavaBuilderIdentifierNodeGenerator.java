...
public abstract class JavaBuilderIdentifierNodeGenerator extends IdentifierNodeGenerator<JavaCodeFragment> {
    ...
    public JavaBuilderIdentifierNodeGenerator(IdentifierNodeGeneratorFactory<JavaCodeFragment> factory,
    ...
    protected JavaBuilderSet getBuilderSet() {
        return builderSet;
    }

    /**
     * Returns the IPS project this generator's {@link JavaBuilderSet} is responsible for.
     */
