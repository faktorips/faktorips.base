...
public class PolicyCmptSeparateValidatorClassAnnGenFactory implements IAnnotationGeneratorFactory {
    ...
    public IAnnotationGenerator createAnnotationGenerator(AnnotatedJavaElementType type) {
        if (type == AnnotatedJavaElementType.POLICY_CMPT_SEPARATE_VALIDATOR_CLASS) {
            return new PolicyCmptSeparateValidatorClassAnnGen();
        } else {
            return null;
        }
    }
