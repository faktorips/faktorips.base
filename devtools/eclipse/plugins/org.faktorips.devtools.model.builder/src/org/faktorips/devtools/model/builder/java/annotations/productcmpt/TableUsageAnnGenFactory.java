...
public class TableUsageAnnGenFactory implements IAnnotationGeneratorFactory {
    ...
    public IAnnotationGenerator createAnnotationGenerator(AnnotatedJavaElementType type) {
        if (type == AnnotatedJavaElementType.TABLE_USAGE_GETTER) {
            return new TableUsageAnnGen();
        } else {
            return null;
        }
    }
