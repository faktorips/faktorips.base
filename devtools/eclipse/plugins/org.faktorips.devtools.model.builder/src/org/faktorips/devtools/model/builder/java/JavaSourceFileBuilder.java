...
import org.faktorips.devtools.model.builder.base.ISourceFileBuilder;
 ...
 */
public abstract class JavaSourceFileBuilder extends AbstractArtefactBuilder implements ISourceFileBuilder {
    ...
    private String merge(AFile javaFile, String oldContent, String newContent) {
        ...
        JMerger merger;
        try {
            DefaultBuilderSet builderSet = getBuilderSet();
            merger = new JMerger(
                    getJControlModel(),
        ...
        try {
            ...
            throw new IpsException(new IpsStatus(
                    "Can't create JDT Compilation Unit for the already existing Java Source. Probably the code does not compile. " //$NON-NLS-1$
                            + javaFile,
                    e));
        }
        try {
