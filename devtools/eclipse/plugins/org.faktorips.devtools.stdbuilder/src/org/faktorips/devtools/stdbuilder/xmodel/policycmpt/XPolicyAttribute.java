...
public class XPolicyAttribute extends XAttribute {
    ...
    public boolean hasAllValuesMethod() {
        return getDatatype().isEnum() && getDatatype() instanceof GenericValueDatatype
                && IpsStringUtils.isNotBlank(((GenericValueDatatype)getDatatype()).getAllValuesMethodName());
    }
