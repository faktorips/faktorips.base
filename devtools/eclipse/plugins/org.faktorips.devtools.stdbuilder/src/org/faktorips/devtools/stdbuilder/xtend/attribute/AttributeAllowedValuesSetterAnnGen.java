...
public class AttributeAllowedValuesSetterAnnGen implements IAnnotationGenerator {

    @Override
    public JavaCodeFragment createAnnotation(AbstractGeneratorModelNode modelNode) {
        return new JavaCodeFragmentBuilder()
                .annotationLn(IpsAllowedValuesSetter.class, "\"" + modelNode.getName() + "\"").getFragment();
    }
