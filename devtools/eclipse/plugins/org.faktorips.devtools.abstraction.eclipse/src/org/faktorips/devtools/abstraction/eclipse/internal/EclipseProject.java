...
public class EclipseProject extends EclipseContainer implements AProject {
    private static final String NATURE_ID = "org.faktorips.devtools.model.eclipse.ipsnature"; //$NON-NLS-1$
    private static final String OLDER_NATURE_ID = "org.faktorips.devtools.model.ipsnature"; //$NON-NLS-1$
    private static final String OLDEST_NATURE_ID = "org.faktorips.devtools.core.ipsnature"; //$NON-NLS-1$
    ...
    public boolean isIpsProject() {
        return get(() -> project().isOpen()
                && (project().hasNature(NATURE_ID) || project().hasNature(OLDER_NATURE_ID)
                        || project().hasNature(OLDEST_NATURE_ID)));
    }
