...
public class MessageFragmentTest extends TestCase {
    ...
    public void testCreateMessageFragment2() {
        MessageFragment msgFrag = MessageFragment.createMessageFragment("The value a={attribute1} is not b={attribute2}", MessageFragment.VALUES_AS_PARAMETER_NAMES); //$NON-NLS-1$
        String sep = StringUtil.getSystemLineSeparator();
        StringBuffer buf = new StringBuffer();
        buf.append(sep);
        buf.append("StringBuffer text = new StringBuffer();"); //$NON-NLS-1$
    ...
    public void testCreateMessageFragment3() {
        MessageFragment msgFrag = MessageFragment.createMessageFragment("The value a={0} is not b={1}", MessageFragment.VALUES_AS_PARAMETER_NAMES); //$NON-NLS-1$
        String sep = StringUtil.getSystemLineSeparator();
        StringBuffer buf = new StringBuffer();
        buf.append(sep);
        buf.append("StringBuffer text = new StringBuffer();"); //$NON-NLS-1$
