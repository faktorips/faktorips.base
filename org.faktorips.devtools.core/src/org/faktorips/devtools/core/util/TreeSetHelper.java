...
public class TreeSetHelper {
	...
	/**
	 * creates a tree set containing <code>IIpsSrcFile</code>s with alphabetic ordered names
	 * If two names are equal but different source files, both source files are stored in the tree set.
	 *  
	 * @return a tree set containing different <code>IIpsSrcFile</code>s with alphabetic ordered names
	 */
