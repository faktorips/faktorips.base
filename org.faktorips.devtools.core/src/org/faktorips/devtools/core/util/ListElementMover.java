...
/**
 * A helper class that moves a given subset of an list elements one position
 * up or down.
 */
public class ListElementMover {
    ...
    /**
     * Moves the elements identifies by the given indices one position up or
     * down. 
     * 
     ...
     * in the list this mover is constructed for.  
