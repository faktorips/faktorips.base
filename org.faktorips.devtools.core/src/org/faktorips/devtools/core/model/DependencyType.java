...
import org.faktorips.devtools.core.builder.DependencyResolver;
...
public enum DependencyType {
     ...
     * transitive dependencies. While searching for transitive dependencies, the
     * {@link DependencyResolver} will always use the intersection of the previous transitive types
     * and the current transitive types. For example: First a dependency of type {@link #DATATYPE}
     * was found. This dependency type returns {@link #SUBTYPE}, {@link #CONFIGURES} and
     * {@link #INSTANCEOF} as transitive types. For further search only these types of dependencies
     * are considered. In the next step a dependency of type {@link #CONFIGURES} was found. Hence
     * only {@link #SUBTYPE} and {@link #INSTANCEOF} dependencies will be considered. In case of a
     * dependency of type {@link #SUBTYPE} the next step will also consider only {@link #SUBTYPE}
     * and {@link #INSTANCEOF} because of the intersection of the two transitive type sets.
     * <p>
