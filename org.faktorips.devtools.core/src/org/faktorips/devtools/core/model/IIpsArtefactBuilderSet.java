...
public interface IIpsArtefactBuilderSet {
    ...
    /**
     * Returns <code>true</code> if the builder set supports table access functions,
     * otherwise false.
     */
    public boolean isSupportTableAccess();
    
    /**
     * Returns a compilation result that gives access to a table via the indicated
     * function. Returns <code>null</code> if this builder set does not support table
     * access.
     * 
    ...
    /**
     * When the builder set is loaded by the faktor ips plugin the extension describtion label is set by means of
     * this method. This method is called before initialization.
     * 
