...
public class IpsObjectType {
    ...
    /**
     * Returns the IpsObjectType that has the given file extension. Returns null, if no type with
     * the given file extension exists or the given fileExtension is null.
     */
    ...
    /**
     * Returns the IpsObjectType that has the given name. Returns <code>null</code>, if no type with
     * the given name exists or the given name is <code>null</code>.
     */
     ...
     * <code>false</code>. Currently product components, table contents and test cases are product
     * definition objects.
     */
    ...
    /**
     * Returns the name of a file (including the extension) that stores a IpsObject with the given
     * name.
     * 
