 ...
 * state of the model and the real state of the model. E.g. a product component might contain a value
 * for an attribute named "maxSumInsured", but the model does not contain the attribute any longer.
 * In this case the call of {@link #fixAllDifferencesToModel(IIpsProject)} would remove the attribute value
...
public interface IFixDifferencesToModelSupport {
     ...
     * 
     * @param ipsProject The ips project which ips object path is used to search for ips objects needed
     * during the fix. 
     * 
