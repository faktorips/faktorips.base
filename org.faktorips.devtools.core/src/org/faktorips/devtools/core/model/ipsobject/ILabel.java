...
/**
 * A label is an object that has a locale, a value and a plural value. Labels can be attached to IPS
 * object part containers.
 * 
 * @since 3.1
 * 
...
public interface ILabel extends IIpsObjectPart {
     ...
     * 
     * @param value The value for the label, might also be <tt>null</tt>.
     */
     ...
     * 
     * @param pluralValue The plural value for the label, might also be <tt>null</tt>.
     */
