...
/**
 * Converter between the database representation and the internal representation of an IPS Datatype
...
public interface IPersistableTypeConverter {
    ...
    /**
     * Returns the annotation to use on attributes of the given datatype.
     */
    public Annotation getAnnotationForDatatype(Datatype datatype);

    /**
     * Returns an annotation suitable to persist a temporal type as a timestamp.
     */
