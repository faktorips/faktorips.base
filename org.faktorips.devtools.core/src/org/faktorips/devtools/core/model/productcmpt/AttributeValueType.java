...
public enum AttributeValueType {
     ...
     */
    SINGLE_VALUE(SingleValueHolder.DEFAULT_XML_TYPE_NAME) {
        @Override
     ...
     */
    MULTI_VALUE(MultiValueHolder.XML_TYPE_NAME) {
        @Override
        public boolean isResponsibleFor(IProductCmptTypeAttribute attribute) {
            return attribute.isMultiValueAttribute();
        }
     ...
     * 
     * @return Returns the valueHolderFactory.
     */
     ...
     * specify the attribute {@link AbstractValueHolder#XML_ATTRIBUTE_VALUE_TYPE}.
     * 
     * @param valueEl The XML element with the {@link AbstractValueHolder#XML_ATTRIBUTE_VALUE_TYPE}
     *            attribute.
     * 
