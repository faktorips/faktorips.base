 ...
 * <code>IEnumType</code>. <code>IEnumValue</code>s are always contained in an <code>IEnumValueContainer</code>.
 * 
...
public interface IEnumValue extends IIpsObjectPart, IDescribedElement {
    ...
    /**
     * Validation message code to indicate that there are not as many <code>IEnumAttributeValue</code>s
     * as <code>IEnumAttribute</code>s in the <code>IEnumType</code>.
     */
     ...
     * 
     * @throws CoreException If the <code>IEnumType</code> this <code>IEnumValue</code> is based upon cannot
     *             be found.
     */
     ...
     * <p>
     * Returns <code>null</code> if none can be found or if the provided <code>IEnumAttribute</code> is
     * <code>null</code>.
     * <p>
     ...
     * <code>IEnumValueContainer</code>. Clients have to care to only pass <code>IEnumAttribute</code>s that
     * are really part of the referenced <code>IEnumType</code>.
     * 
     * @param enumAttribute The <code>IEnumAttribute</code> to obtain the <code>IEnumAttributeValue</code>
     *            for.
     */
     ...
     * 
     * @throws CoreException If an error occurs while searching for the <code>IEnumAttributeValue</code>
     *             that refers to the given <code>IEnumAttribute</code>.
    ...
    /**
     * Sets the value of the <code>IEnumAttributeValue</code> that refers to the <code>IEnumAttribute</code>
     * identified by the given name.
     * 
     * @param enumAttributeName The name of the <code>IEnumAttribute</code> for that the value shall be
     *            set.
     * @param value The new value. May also be <code>null</code>.
     * 
     ...
     * @throws NoSuchElementException If there is no <code>IEnumAttribute</code> with the given name in
     *             the parent <code>IEnumType</code>.
     */
    ...
    /**
     * Returns a list containing all <code>IEnumAttributeValue</code>s that refer to the given unique
    ...
    /**
     * Returns the index of the given <code>IEnumAttributeValue</code> in this <code>IEnumValue</code> or -1
     * if the given <code>IEnumAttributeValue</code> does not exist in this <code>IEnumValue</code>.
     * 
    ...
    /**
     * Returns the <code>IEnumAttributeValue</code> referencing the <code>IEnumLiteralNameAttribute</code>
     * or <code>null</code> if there exists none or this <code>IEnumValue</code> is part of an
