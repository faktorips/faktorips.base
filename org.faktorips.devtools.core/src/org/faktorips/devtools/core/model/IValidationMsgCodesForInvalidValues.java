...
/**
 * This interface defines global validation message codes that are used by the validation
 * of different ips objects / parts.
 * 
...
public interface IValidationMsgCodesForInvalidValues {
    ...
    /**
	 * Validation message code to indicate that a value is not an "instance" of the value datatype,
