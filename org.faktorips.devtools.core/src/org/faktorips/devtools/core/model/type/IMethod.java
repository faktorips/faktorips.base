...
public interface IMethod extends IParameterContainer {
    ...
    /**
     * Returns the method's (return) datatype. Returns <code>null</code> if the datatype can't be
     * found.
     * 
     * @param project The project which ips object path is used to search. This is not necessarily
     *            the project this method belongs to.
     * 
    ...
    /**
     * Returns <code>true</code> iff this method overrides the <code>otherMethod</code>. This method
     ...
     * The signature is the same iff the name of the method is equal, the number of parameters is
     * equal and the data types of the parameters are equal. Note that the return values are not
     * compared.
     * 
     * @param otherMethod the other method, this method have to be compared with
     * @return <code>true</code> iff the signature of the other method is the same as the signature
     *         of this method
     * 
     */
    ...
    /**
     * Returns the method's signature in String format, e.g. computePremium(base.Coverage,
     * base.Contract, Integer)
     */
