 ...
 * @author Jan Ortmann
 */
public interface IProductCmptTypeAssociation extends IIpsObjectPart {
     ...
     */
    public boolean isSubsetOfDerivedUnion(IProductCmptTypeAssociation derivedUnion, IIpsProject ipsProject) throws CoreException;
