...
class IpsActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void fillMenuBar(IMenuManager menuBar) {
		...
		if (PlatformUI.getWorkbench().getActiveWorkbenchWindow() != null) {
			disableUnwantedActionSets(PlatformUI.getWorkbench()
	...
	private MenuManager createFileMenu() {
		MenuManager menu = new MenuManager(Messages.IpsActionBarAdvisor_file,
	...
	private MenuManager createEditMenu() {
		MenuManager menu = new MenuManager(Messages.IpsActionBarAdvisor_edit,
	...
	private MenuManager createNavigateMenu() {
		MenuManager menu = new MenuManager(Messages.IpsActionBarAdvisor_navigate,
				IWorkbenchActionConstants.M_NAVIGATE);
		menu.add(new GroupMarker(IWorkbenchActionConstants.NAV_START));
		menu.add(goIntoAction);

		MenuManager goToSubMenu = new MenuManager(Messages.IpsActionBarAdvisor_goto,
	...
	private MenuManager createProjectMenu() {
		MenuManager menu = new MenuManager(Messages.IpsActionBarAdvisor_project,
	...
	private MenuManager createWindowMenu() {
		MenuManager menu = new MenuManager(Messages.IpsActionBarAdvisor_Window,
...
//		menu.add(editActionSetAction);
	...
	private MenuManager createHelpMenu() {
		MenuManager menu = new MenuManager(Messages.IpsActionBarAdvisor_help,
	...
	private void addSeparatorOrGroupMarker(MenuManager menu, String groupId) {
		...
		boolean addExtraSeparators = IpsPlugin.getDefault()
