...
/**
 * Migration from version 2.5.4.rfinal to version 3.0.0.ms1 Manually steps: if the master to detail
 ...
 */
public class Migration_2_5_4_rfinal extends AbstractIpsProjectMigrationOperation {
    ...
    public Migration_2_5_4_rfinal(IIpsProject projectToMigrate, String featureId) {
