 ...
 * returns the custom validations for PolicyCmptTypeAttribute, but also custom validations
 * responsible for IPolicyCmptTypeAttribute, Attribute and IAttribute.
 * <p>
