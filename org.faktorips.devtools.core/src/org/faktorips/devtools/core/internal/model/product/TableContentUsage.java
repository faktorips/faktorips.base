...
public class TableContentUsage extends AtomicIpsObjectPart implements ITableContentUsage {
    ...
    protected void validateThis(MessageList list) throws CoreException {
        ...
        ITableStructureUsage tsu = type.findTableStructureUsageInSupertypeHierarchy(structureUsage, true, ipsProject);
        if (tsu == null) {
	...
	public ITableStructureUsage findTableStructureUsage(IIpsProject ipsProject) throws CoreException {
		...
		return type.findTableStructureUsageInSupertypeHierarchy(structureUsage, true, ipsProject);
	}
