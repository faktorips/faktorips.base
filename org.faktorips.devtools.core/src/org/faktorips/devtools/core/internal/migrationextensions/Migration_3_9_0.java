...
public class Migration_3_9_0 extends DefaultMigration {

    public Migration_3_9_0(IIpsProject ipsProject, String featureId) {
    ...
    public String getTargetVersion() {
        return "3.9.0"; //$NON-NLS-1$
    }

    @Override
    public String getDescription() {
        return Messages.Migration_3_9_0_description;
    }
    ...
    public static class Factory implements IIpsProjectMigrationOperationFactory {
        ...
        public AbstractIpsProjectMigrationOperation createIpsProjectMigrationOpertation(IIpsProject ipsProject,
                String featureId) {
            return new Migration_3_9_0(ipsProject, featureId);
        }
