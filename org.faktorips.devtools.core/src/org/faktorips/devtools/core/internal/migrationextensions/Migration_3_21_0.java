 ...
 */
public class Migration_3_21_0 extends DefaultMigration {

    private Migration_3_21_0(IIpsProject projectToMigrate, String featureId) {
        super(projectToMigrate, featureId);
    }

    @Override
    public String getTargetVersion() {
        return "3.21.0"; //$NON-NLS-1$
    }

    @Override
    public String getDescription() {
        return Messages.Migration_3_21_0_description;
    }
    ...
    public static class Factory implements IIpsProjectMigrationOperationFactory {
        ...
        public AbstractIpsProjectMigrationOperation createIpsProjectMigrationOpertation(IIpsProject ipsProject,
                String featureId) {
            return new Migration_3_21_0(ipsProject, featureId);
        }
    }
}
