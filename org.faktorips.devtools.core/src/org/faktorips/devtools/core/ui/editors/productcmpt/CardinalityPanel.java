...
public class CardinalityPanel implements IDataChangeableReadWriteAccess {
	...
	public CardinalityPanel(Composite parent, UIToolkit toolkit) {
		...
		Composite kardinalityPane = toolkit
				.createLabelEditColumnComposite(root);
