...
public class TblsStructureUsageEditDialog extends IpsPartEditDialog{
    ...
    /*
     * Simple array content provider to provide all table stuctures inside a table structure
    ...
    private void createTable(Composite composite) {
        ...
        column.setText(Messages.TblsStructureUsageEditDialog_TableColumn_TableStructure);
    ...
    private void createButtons(Composite composite) {
        ...
        btnDown = uiToolkit.createButton(buttonComposite, Messages.TblsStructureUsageEditDialog_Button_Down);
    ...
    private ITableStructure selectTableStructureByDialog() throws CoreException {
        ...
        selectDialog.setTitle(Messages.TblsStructureUsageEditDialog_SelectTableStructureDialog_Title);
        selectDialog.setMessage(Messages.TblsStructureUsageEditDialog_SelectTableStructureDialog_Description);
