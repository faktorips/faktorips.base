...
public class Messages extends NLS {
    ...
    public static String ObjectPathEntryLabelDecorator_11;
    public static String ObjectPathEntryLabelDecorator_9;
    ...
    public static String suffix_derived_folder_not_existing;
    public static String suffix_derived_folder_undefined;
    public static String suffix_mergable_folder_not_existing;
    public static String suffix_mergable_folder_undefined;
    public static String suffix_missing;
    public static String suffix_missing_folder;
    public static String suffix_missing_project;
    public static String suffix_not_child_of_root;
    public static String suffix_not_specified;
    public static String suffix_project_not_specified;
