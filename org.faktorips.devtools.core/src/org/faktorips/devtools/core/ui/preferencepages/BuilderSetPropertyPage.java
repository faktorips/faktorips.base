        ...
        if (builderSetContainer != null) {
            if (! visible) {
                if (builderSetContainer.hasChangesInDialog()) {
                    String title = "Setting IPS Builder Set";
                    String message = "The IPS builder set property page contains unsaved modifications. Do you want to save changes so that other property pages can be updated?"; 
