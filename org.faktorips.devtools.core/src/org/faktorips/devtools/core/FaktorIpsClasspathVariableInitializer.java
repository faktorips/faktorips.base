...
public class FaktorIpsClasspathVariableInitializer extends ClasspathVariableInitializer {
    ...
    public final static String[] IPS_VARIABLES_JAVA5_BIN = new String[] { VARNAME_VALUETYPES_JAVA5_BIN, VARNAME_RUNTIME_JAVA5_BIN };
    ...
    public final static String[] IPS_VARIABLES_JAVA5_SRC = new String[] { VARNAME_VALUETYPES_JAVA5_SRC, VARNAME_RUNTIME_JAVA5_SRC }; //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public FaktorIpsClasspathVariableInitializer() {
            ...
            add(new Mapping(VARNAME_VALUETYPES_JAVA5_SRC, "org.faktorips.valuetypes.java5", "/faktorips-valuetypes.java5-src.zip")); //$NON-NLS-1$ //$NON-NLS-2$
            add(new Mapping(VARNAME_RUNTIME_JAVA5_BIN, "org.faktorips.runtime.java5", "/faktorips-runtime.java5.jar")); //$NON-NLS-1$ //$NON-NLS-2$
            add(new Mapping(VARNAME_RUNTIME_JAVA5_SRC, "org.faktorips.runtime.java5", "/faktorips-runtime.java5-src.zip")); //$NON-NLS-1$ //$NON-NLS-2$
