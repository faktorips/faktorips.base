...
/**
 * Base class for all exceptions generated by the JET engine. Makes it convenient to catch just this
 * at the top-level.
 */
public class JETException extends DiagnosticException {
    ...
    /**
     * Creates a JETException with the embedded exception and the reason for throwing a
     * JETException.
     */
    public JETException(String reason, Throwable exception) {
        super(new BasicDiagnostic(Diagnostic.ERROR, CodeGenPlugin.INSTANCE.getSymbolicName(), 0, reason,
