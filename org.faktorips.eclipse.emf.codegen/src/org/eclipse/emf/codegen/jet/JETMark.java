...
public final class JETMark {
    ...
    /**
     * Keep track of parser before parsing an included file. This class keeps track of the parser
    ...
    class IncludeState {
        ...
        IncludeState(int inCursor, int inLine, int inCol, int inFileid, String inBaseDir, String inEncoding,
                char[] inStream) {
            cursor = inCursor;
            line = inLine;
            col = inCol;
    ...
    /**
     * Sets this mark's state to a new stream. It will store the current stream in it's
     * includeStack.
     * 
    ...
    public String format(String key) {
        return CodeGenPlugin.getPlugin().getString(key, new Object[] { getLocalFile(), line + 1, col + 1, cursor });
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof JETMark) {
            ...
            return this.reader == m.reader && this.fileid == m.fileid && this.cursor == m.cursor && this.line == m.line
                    && this.col == m.col;
        }
        return false;
    }
