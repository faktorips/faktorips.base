...
public interface JMethod extends JMember {
     ...
     * 
     * @param typeParameters in the order declared in the source, or an empty array if no type
    ...
    /**
     * Returns the names of parameters in this method in the order they are declared, or an empty
     * array if no parameters are declared. The parameter names are identifiers as defined by Formal
     * Parameters (JLS2 and JLS3 8.4.1). Parameter names do not include extra dimensions.
     * 
     * @return the list of parameter names, or an empty array if no parameters are declared
     */
    String[] getParameterNames();

    /**
     * Returns the erased type names for the parameters of this method in the order they are
     * declared, or an empty array if no parameters are declared. The syntax for type names is
    ...
    /**
     * Returns the full types for the parameters of this method in the order they are declared, or
     * an empty array if no parameters are declared. The syntax for type names is defined by Formal
    ...
    /**
     * Sets the names of parameters in this method in the order they are to be declared. The
     * parameter names are identifiers as defined by Formal Parameters (JLS2 and JLS3 8.4.1).
    ...
    /**
     * Returns the parameters of this method in the order they are declared, or empty array if no
     * parameters are declared. The syntax for the parameters is defined by Formal Parameters (JLS2
     * and JLS3 8.4.1). Types and parameter names must be specified as they would appear in source
     * code. For example: <code>"File file"</code>, <code>"java.io.File file"</code>, or
     * <code>"int[][] n[]"</code>, or <code>final @Annotation int[]... n</code>.
     * 
     * @return the list of parameters, or or an empty array if no parameters are declared
     * @since 2.3.0
     */
    String[] getParameters();

    /**
     * Sets the parameters in this method in the order they are to be declared. The syntax for the
     * parameters is defined by Formal Parameters (JLS2 and JLS3 8.4.1). Types and parameter names
     * must be specified as they would appear in source code. For example: <code>"File file"</code>,
     * <code>"java.io.File file"</code>, or <code>"int[][] n[]"</code>, or
     * <code>final @Annotation int[]... n</code>.
     * 
     * @param parameters the list of parameters, or or an empty array if no parameters are declared
     * @since 2.3.0
     */
     ...
     * types), and either basic (for basic types) or rich (for parameterized types).
     * </p>
     *
     * @return the list of the exceptions, or an empty array if no exceptions are declared
     */
