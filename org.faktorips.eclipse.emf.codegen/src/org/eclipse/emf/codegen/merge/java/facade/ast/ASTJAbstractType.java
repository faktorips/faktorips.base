...
public abstract class ASTJAbstractType<T extends AbstractTypeDeclaration> extends ASTJMember<T> implements
     ...
     * <p>
     * This implementation supports moving the nodes by calling {@link #remove(ASTJNode)} and then
     * {@link #insertSibling(ASTJNode, ASTJNode, boolean)} or {@link #addChild(ASTJNode)}.
     * 
