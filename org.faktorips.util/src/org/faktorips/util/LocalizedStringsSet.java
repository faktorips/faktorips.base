 ...
 * Therefore the set's qualified name is the package name, followed by a dot (.),
 * followed by the prefix, e.g. "org.faktorips.fl.Messages". For further
 * information see the {@link java.util.ResourceBundle ResourceBundle} documentation.
 * <p>
